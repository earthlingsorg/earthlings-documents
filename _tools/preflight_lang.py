...
notofonts.github.io содержит 2 ASCII-символа из 95, и PDF Обращения вышел бы с
...
# теоретический: каждый из них стоит в Обращении, и каждый выпадал бы в
...
def main():
    ...
    if rl_ok:
        ...
        print('   Решать это ДО перевода, а не после: от выбора движка '
              'зависит, как собирается Обращение и все страницы.')
