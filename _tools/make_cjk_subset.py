"""Печёт субсет Noto Serif SC для китайского PDF Манифеста.
...
Откуда берутся знаки. Из той же страницы mainpage/zh/index.html, из которой
...
Скрипт разовый: перезапускать нужно, только если в китайском Манифесте
