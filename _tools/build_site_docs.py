...
LANGS_BY_DOC = {'02': ['ar', 'de', 'en', 'es', 'fr', 'hi', 'ka', 'ru', 'zh'],
                ...
                # французскому, китайскому и хинди они пришли вместе с
                # сокращённой редакцией 02: приложение и резка 02 - одно и то
                # же изменение, порознь их выкладывать нельзя. Остальные два
                # языка приложений пока не собирают, и ссылок на них там нет:
                # документ 02 в них прежней, несокращённой редакции, и
                # выносить из него нечего.
                '02a': ['de', 'en', 'es', 'fr', 'hi', 'ru', 'zh'],
                '02b': ['de', 'en', 'es', 'fr', 'hi', 'ru', 'zh'],
                '02c': ['de', 'en', 'es', 'fr', 'hi', 'ru', 'zh'],
