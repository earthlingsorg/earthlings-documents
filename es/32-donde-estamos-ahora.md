...
- **Las votaciones de la DAO.** Abrir el espacio en Snapshot y ver las propuestas, los votos y las firmas. Cada voto está firmado con el monedero de quien vota: nosotros no podemos ni añadir un voto ni falsificar el de otro. Los votos en este canal son abiertos; qué cambia eso, en la sección «Qué no hay todavía».
