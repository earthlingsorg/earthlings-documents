...
Los documentos constitutivos del proyecto describen ese modelo como la arquitectura de una sociedad en la que el poder no se acumula en ningún punto. Earthlings reúne a personas de distintos países en torno a la Declaración sobre la libre determinación - un núcleo constitutivo intangible que ninguna mayoría puede reescribir - y a una infraestructura digital que asegura una participación verificada conforme al principio «una persona, un voto» a escala planetaria.
...
- el Emergency Multisig - SEGURIDAD;
- el Consejo Independiente - CONSULTA.

La Asamblea DAO, que comprende a todos los Earthlings, adopta las decisiones vinculantes.

Los Core Nodes aseguran la coordinación técnica y se renuevan por rotación.
...
- la distribución transparente de recursos;
- la coordinación de las actuaciones entre los Earthlings y las células;
- el funcionamiento del sistema sin poder centralizado.
...
- la relación con instituciones externas;
- la celebración de contratos;
- la contabilidad fiscal y administrativa.

Tales estructuras sirven exclusivamente de medios operativos sustituibles de relación externa:

- no definen al pueblo ni su existencia;
- no portan legitimidad y no tienen poder sobre el pueblo;
...
- revisiones recomendadas de las decisiones de la DAO;
- informes públicos anuales.

El Consejo no tiene derecho de veto sobre las decisiones de la DAO.
...
El proyecto lo ha puesto en marcha Artur Arakelyan; hasta este momento se ha financiado por completo con sus fondos personales.

A día de hoy no se ha captado financiación externa.
