...
> **Qué es este documento.** Respuestas breves a lo que más se pregunta, con indicación de dónde buscar la respuesta completa. No establece nada y no crea reglas: las reglas están en la [Carta](https://earth-lings.org/documents/ru/ru05-ustav.html) y en la [Declaración](https://earth-lings.org/documents/ru/ru01-deklaraciya.html), y ante cualquier discrepancia se aplican ellas.
>
> Las objeciones jurídicas - sobre la libre determinación, la personalidad jurídica y el reconocimiento - están examinadas aparte, con detalle y con los argumentos en contra nuestra: [Objeciones y respuestas](https://earth-lings.org/documents/ru/ru26-pravovye-vozrazheniya.html).

---

# I. Dinero y participación
...
→ [Tesorería](https://earth-lings.org/documents/ru/ru09-kaznachejstvo.html)

### ¿Habrá más pagos después?

No. La cuota es única: tras obtener el pasaporte no existen pagos anuales ni mensuales.

→ [El camino del earthling](https://earth-lings.org/documents/ru/ru14-put-earthling.html)
...
### No tengo tiempo ni ganas de participar activamente. ¿Tiene sentido adherirse?

Sí. Tras obtener el pasaporte no hay actividad obligatoria: se puede seguir siendo participante sin dedicarle tiempo e implicarse más tarde, o no implicarse en absoluto.
...
→ [Carta, artículo 20](https://earth-lings.org/documents/ru/ru05-ustav.html)

### ¿Qué pasará con mi nacionalidad y con mis impuestos?

Nada. La nacionalidad, los impuestos y el fuero no se ven afectados. El pasaporte earthling no da derechos de visado, no sustituye a los documentos de su país y no tiene eficacia ante las instituciones estatales.

→ [Pasaporte SBT](https://earth-lings.org/documents/ru/ru15-sbt-pasport.html)

---

# II. Identidad y datos
...
→ [Política de verificación biométrica](https://earth-lings.org/documents/ru/ru16-biometricheskaya-verifikaciya.html)
...
→ [Política de privacidad](https://earth-lings.org/documents/ru/ru28-politika-konfidencialnosti.html)

### ¿Entregan datos a los Estados?

Solo por una resolución judicial firme o un requerimiento legal equivalente, cuya legitimidad se comprueba en cada caso. Al participante se le avisa de ello, salvo que la resolución prohíba el aviso.
...
**Y el voto tampoco se puede retirar por sus opiniones.** Ni por cómo vote, ni por el desacuerdo con las decisiones, ni como castigo general por infringir las reglas. Las limitaciones de los cinco niveles afectan a la participación en las células - grupos pequeños de trabajo -, al derecho de presentar propuestas y al acceso a los servicios, pero no al voto ni a la pertenencia.
...
→ [Carta, artículos 17 y 22](https://earth-lings.org/documents/ru/ru05-ustav.html)
...
→ [Hoja de ruta](https://earth-lings.org/documents/ru/ru19-dorozhnaya-karta.html)
...
→ [Hoja de ruta, sección 07](https://earth-lings.org/documents/ru/ru19-dorozhnaya-karta.html)

### El Consejo Independiente, ¿es un senado en la sombra?

No. Sus dictámenes son solo de recomendación: no puede bloquear decisiones, no tiene veto, no participa en las finanzas y ni siquiera puede retrasar que una cuestión se someta a votación. A un miembro suyo solo se le puede revocar por un fundamento nombrado, y el desacuerdo con su posición no es tal fundamento.

El Consejo no está constituido todavía.

→ [Consejo Independiente](https://earth-lings.org/documents/ru/ru11-nezavisimyj-sovet.html)
...
### ¿En qué se diferencian de otras DAO?

La infraestructura es la misma, y fingir lo contrario no tiene sentido. La diferencia está en aquello a lo que está conectada.

Los intentos anteriores se rompieron por tres cosas. Un token, un voto: decide quien tiene más medios. No hay verificación de identidad: una misma persona vota con multitud de monederos. No hay un fundamento intangible: las propias reglas de la votación pasan a ser objeto de votación.

Aquí el voto está ligado a una persona viva verificada y no depende del saldo; la unidad de cuenta no da votos en ninguna cantidad; las organizaciones no pueden ser participantes; y la pertenencia, el voto igual, el derecho a marcharse y los valores están sacados por completo fuera de la votación.

¿Está esta construcción comprobada a escala? No. Decimos solo que las causas del fracaso de los intentos anteriores están nombradas y que las respuestas a ellas están incorporadas a la arquitectura.

→ [Objeciones y respuestas](https://earth-lings.org/documents/ru/ru26-pravovye-vozrazheniya.html)
...
→ [Plataforma digital](https://earth-lings.org/documents/ru/ru12-cifrovaya-platforma.html)
...
### ¿Qué funciona ya de verdad y qué no?
...
*La lista está abierta: a medida que aparezcan preguntas nuevas, el documento se completa.*
