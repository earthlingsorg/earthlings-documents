...
Cómo un pueblo que se crea a sí mismo adopta su propio texto constitutivo

## Para qué un período constituyente

Un pueblo que se crea a sí mismo debe adoptar por sí mismo las reglas sobre las que se fundará.

Por eso los Earthlings empiezan con un período constituyente.
...
Al final de este período, la Declaración se someterá a votación conjunta; el período concluirá cuando la votación haya decidido definitivamente si el texto se adopta o no. Si se adopta, se convertirá en el documento constitutivo del pueblo, y los principios de su núcleo intangible serán inderogables para siempre.

Esto es de principio.

No queremos crear primero un pueblo con reglas ya hechas y proponer después a sus participantes que las acepten. Queremos que el proceso mismo de constitución sea colectivo.

Por eso cualquier persona puede proponer un cambio. Cada propuesta será examinada y publicada junto con su respuesta. Y la decisión definitiva la adoptarán los propios participantes en la constitución.

Tras la adopción, los principios de la parte I de la Declaración se hacen intangibles precisamente porque la Declaración la adoptó aquel a quien une.

Modificables seguirán siendo las instituciones, los procedimientos, los mecanismos económicos y los modos de trabajar juntos. Deben evolucionar con el pueblo.

Intangible queda únicamente su base constitutiva: los principios establecidos en la parte I de la Declaración; sobre ellos se sostiene la pertenencia voluntaria de una persona a este pueblo.

Queremos así que los Earthlings no se creen para las personas, sino **por las personas mismas**.
...
Tras la adopción, los principios de la parte I de la Declaración serán intangibles porque la Declaración la habrá adoptado aquel a quien une.

Hay una segunda razón. Un pueblo construido sobre la participación común no puede llegar hecho a las personas. Mientras los textos no estén adoptados, cada cual tiene la posibilidad de influir en ellos, y esa posibilidad es real y no decorativa: lo que entre en la Declaración regirá sin plazo, lo que entre en la Carta empezará a regir como Carta junto con la Declaración, y lo que entre en los demás documentos, de inmediato.

## 02. Qué está abierto a propuestas

Está abierto todo el corpus, incluido el presente documento. Se puede presentar una propuesta respecto de cualquier documento, y el derecho a presentarla es igual para todos. Distintas serán las consecuencias, porque los documentos tienen fuerza distinta; los límites de la modificación de la parte 2 del presente documento están establecidos en ella misma (sección 2).
...
Tras la adopción, los principios del núcleo no se derogan nunca, y las demás disposiciones las cambia el propio pueblo, por dos tercios de los votos y solo de modo que ninguna garantía de la persona quede debilitada.
...
### Los documentos de arquitectura
...
| Los documentos de arquitectura | no | de inmediato | la Asamblea conforme a la Carta |
| Los externos y de consulta | no | de inmediato | la Asamblea, salvo lo prescrito por la ley |

## 03. Qué no se discute

Cinco disposiciones principales no se discuten en ninguna circunstancia. Un pueblo con el que quepa regatear esas disposiciones no se diferencia en nada del que ya existe.
...
Las cinco están recogidas en la parte I de la Declaración y enumeradas en su artículo 11 como los principios principales del núcleo intangible, y el núcleo mismo lo forma toda la parte I. Las propuestas dirigidas a derogar o restringir sus principios no se examinan. Las propuestas de precisar sus redacciones y de completar el núcleo se examinan en igualdad con todas.
...
## 04. Test para el núcleo intangible

Un principio que ha entrado en el núcleo intangible ya no se puede derogar nunca. Por eso una propuesta se incluye en el núcleo solo si reúne las cuatro condiciones a la vez:

1. protege a la persona frente al poder del propio pueblo, y no describe de qué se ocupa el pueblo;
2. se formula como una prohibición, y no como una tarea;
3. es verificable: se puede establecer si se ha infringido o no;
4. sigue siendo verdadera aunque nos hayamos equivocado al valorar las circunstancias.

«El voto no se puede comprar» reúne las cuatro. «El pueblo se ocupa del clima» no reúne ninguna: es una tarea, las tareas cambian, y su lugar está en la Carta.

## 05. Cómo participar

Hay dos vías, y no son lo mismo.

**Enviar una objeción o una propuesta.** A cualquier documento del corpus, y no solo a la Declaración. Para ello no hace falta adherirse, ni verificar la identidad, ni estar de acuerdo con nuestras conclusiones. Basta con nombrar el documento y el lugar dentro de él; si no sabe cómo se llama el documento, descríbalo con palabras: ya lo averiguaremos nosotros. Cada propuesta se publica junto con su respuesta, tanto las aceptadas como las rechazadas, con indicación del motivo del rechazo.
...
La respuesta se publica en inglés y en la lengua de la propuesta. Digamos aquí de entrada lo que si no se preguntará: en chino, árabe, hindi y georgiano no tenemos todavía hablante nativo, y la respuesta en esas lenguas puede ser menos fluida que en inglés. El sentido de la respuesta no cambia por ello, y no habrá diferencia de fondo entre las versiones.

Hay también una segunda razón para abrir las nueve lenguas, además de la evidente. Una persona que lee la Declaración en su lengua advierte en la traducción lo que nosotros no vemos. Esas observaciones no son para nosotros menos valiosas que las objeciones de fondo, y pedimos que se nos envíen.

Participar en la constitución no da ventaja alguna después de ella. En este pueblo no habrá una clase de fundadores: así está escrito en el artículo 8 de la Declaración y se desprende de su núcleo intangible: por el artículo 4, la fuerza del voto no depende ni del tiempo de participación ni de los méritos.

## 06. Qué pasa si usted no está de acuerdo con el texto adoptado

No ocurrirá nada contra su voluntad.

Hasta la adopción usted es participante en la constitución y no earthling: por ahora no hay nada que firmar. El día de la adopción usted vota. Si el texto adoptado no le conviene, sencillamente no lo firma y se va, en cualquier momento, sin explicar los motivos y sin el consentimiento de nadie.

Ninguna decisión adoptada antes de su acuerdo le obliga a nada.
...
Por correo a team@earth-lings.org. En el asunto basta una palabra: objeción.

Todas las propuestas y sus respuestas se llevan en un registro abierto: <https://github.com/earthlingsorg/earthlings-documents>. Puede consultarlo cualquier persona sin inscribirse; presentar propuestas directamente allí también se puede, si le resulta más cómodo, pero para ello hace falta una cuenta de GitHub; sin ella basta con un correo. En el registro está todo el corpus y no solo la Declaración, y cada cambio de cualquier documento se ve en él línea por línea y está ligado a la propuesta que lo originó.

Respondemos a todo y publicamos todo, incluido lo que no nos conviene. Todos los argumentos que conocemos contra nuestra propia construcción los hemos escrito nosotros mismos antes de pedírselo a otros.

# Parte 2. Reglas del período constituyente

La presente sección establece el procedimiento al que remite la sección «Estado de la presente versión» de la Declaración.
...
La propuesta se acepta en cualquiera de las nueve lenguas del corpus: inglés, ruso, alemán, español, francés, chino, árabe, hindi y georgiano. No se exige a quien la presenta que la traduzca a otra lengua, y por la lengua una propuesta no se rechaza.

La respuesta se publica en inglés y en la lengua de la propuesta.

**Dos clases de propuestas, con consecuencias distintas.**

Una propuesta **de fondo** modifica el sentido del texto. Se incorpora al texto maestro ruso, se reproduce en el inglés, y después esos mismos cambios se trasladan a las otras siete lenguas. La lengua en la que llegó la propuesta no influye en ello.

Una propuesta **de traducción** señala que la traducción transmite el sentido de manera inexacta. Corrige el texto únicamente de la lengua a la que se refiere y no cambia el sentido del documento. No es una propuesta de modificación de la Declaración y no se somete a votación.
...
Cada propuesta recibida se publica junto con su respuesta, tanto si se acepta como si se rechaza, con indicación del motivo del rechazo. La respuesta se publica en un plazo no superior a treinta días desde la recepción de la propuesta y, para las propuestas recibidas en los últimos treinta días del plazo, no más tarde del día de publicación del compendio.

La publicación se lleva en el registro abierto indicado en la sección «Adónde enviarlas». Cada propuesta se abre allí como asiento propio, la respuesta se adjunta a él, y toda enmienda de cualquier documento del corpus se vincula a la propuesta que la originó. Quién ha influido y en qué en el texto se ve en el propio registro y no depende de que nos acordemos de decirlo.

La decisión de incluir una propuesta en el texto la adopta el autor de la Declaración, para todos los documentos del corpus. Es la única facultad discrecional del período constituyente respecto de los textos, y aquí se nombra de manera expresa (dónde hay que confiar en el fundador antes de la adopción está señalado en el documento «Dónde estamos ahora»): hasta la adopción del texto no hay un pueblo que pueda decidir en lugar del autor, y ceder esa decisión a un grupo significaría hacer constituyentes no a los participantes, sino a unos invitados.
...
Las propuestas dirigidas a derogar o restringir los principios establecidos en la parte I de la Declaración (los principales están enumerados en su artículo 11) no se examinan. Las propuestas de precisar las redacciones de la parte I se examinan en igualdad con las demás.
...
## 5. Verificación de identidad durante el período

A la verificación de identidad durante el período constituyente se aplican de manera temporal las reglas del artículo 8 de la Declaración en la presente versión.

La firma de la Declaración y la adhesión al pueblo están suspendidas mientras dura el período constituyente: por ahora no hay nada que firmar, y un pueblo definido por un texto adoptado todavía no existe.

La verificación de identidad se realiza de manera gratuita y continúa durante todo el período. Como resultado de la verificación se expide un documento temporal de participante en la constitución, que no sustituye ni anticipa el pasaporte earthling, que, tras la adopción del texto, empezará a expedirse en régimen ordinario. Se puede renunciar en cualquier momento a la condición de participante en la constitución: el documento temporal lo destruye su titular por sí mismo, con su propia clave, y nadie puede impedirlo. Contra la voluntad de su titular, el documento temporal se destruye únicamente por uno de los tres fundamentos del artículo 8 de la Declaración: que a una misma persona se le haya expedido más de un documento en vigor (se destruyen todos salvo el expedido en primer lugar), que la verificación se haya obtenido empleando datos falsos o la identidad de otra persona, o que el documento se haya expedido a quien no ha cumplido 18 años. La decisión al respecto y, cuando el fundamento sea la edad, también la de suprimir los datos (Política de privacidad, sección 10), las adopta el autor de la Declaración: al titular se le comunican el fundamento y el plazo para objetar, a las objeciones se les da respuesta (Declaración, artículo 4), y el documento se destruye solo si el fundamento se confirma tras su examen; hasta la adopción de la Declaración no hay órgano ante el que recurrir. Esta facultad no es discrecional: los fundamentos son tres, y no hay otros.
...
3. han participado en la votación no menos del treinta por ciento del número total de participantes verificados el día de la votación; en ese número entran solo los titulares de un documento temporal en vigor.
...
## 8. Vigencia de las presentes reglas

Las presentes reglas rigen desde el día en que se abre la recepción de propuestas y pierden vigencia en el momento de la adopción del texto y, si el texto no se adopta, con la publicación de su no adopción.
