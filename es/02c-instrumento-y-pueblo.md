# Por qué el instrumento no puede prescindir de un pueblo

**Cinco razones por las que una medición verificable de la voluntad común no puede prescindir de un pueblo; el caso del mayor proyecto construido sin él; nueve maneras en que todo esto puede no llegar a producirse; y aquellos que no tienen representación alguna**

> **Condición del presente anexo.** Es un anexo del documento [«Voz ciudadana»](https://earth-lings.org/documents/es/es02-voz-ciudadana.html). No establece nada y no crea deberes: aporta los casos, las cifras y las fuentes de las afirmaciones de ese documento. En caso de discrepancia se aplica «Voz ciudadana»; fuerza obligatoria la tienen la [Declaración](https://earth-lings.org/documents/es/es01-declaracion.html) y la [Carta](https://earth-lings.org/documents/es/es05-carta.html).

La mayor parte de un instrumento de medición se puede construir sin pueblo alguno. La verificación de la unicidad de una persona sin revelar su identidad no exige un pueblo: esos sistemas existen y funcionan. La votación verificable por firmas de monederos no exige un pueblo. La base para el sorteo es un problema estadístico corriente. Los paneles deliberativos los organizan los Estados, las universidades y las organizaciones sin ánimo de lucro, y desde hace mucho y bien.
...
Así pues, la pregunta hay que plantearla con más precisión. No «qué sería más difícil sin un pueblo», sino **qué sería imposible**. Siguen cinco respuestas independientes; cada una se sostiene por sí sola, y si una resulta equivocada, las demás no caen.
...
## Tercera. El núcleo intangible no es solo ética: protege al instrumento frente a su captura
...
El núcleo es la única construcción que conocemos en la que el ataque de «comprar» carece de objeto: no hay nada que comprar, porque el voto es inalienable. Pero para que existan principios así hace falta un documento situado por encima de la dirección, es decir, un texto constitutivo que el propio operador no puede reescribir.

### Una comprobación viva de este razonamiento

Es más honrado nombrarla por su nombre que rodearla con una alusión.
...
No consideramos que ese proyecto sea de mala fe y no discutimos su parte técnica; mucho de ella está hecho mejor que lo nuestro. Señalamos otra cosa: **el mismo instrumento, construido sin un pueblo, ha recibido exactamente la suerte que predicen las exigencias de un texto constitutivo y de la ausencia de dueño.** Tiene dueño, y eso significa que se lo puede comprar. No tiene composición, sino usuarios, y eso significa que el denominador lo fija la empresa. Y a la pregunta «quién les ha facultado a ustedes para preguntar» no tiene con qué responder.
...
¿El beneficio? El rendimiento de una sola respuesta ronda el cero: es el mismo Olson del anexo [«Por qué el recuento está roto»](https://earth-lings.org/documents/es/es02a-recuento-roto.html), solo que ahora golpea el funcionamiento del propio instrumento. ¿El dinero? Una respuesta pagada devalúa la medición, y pagar a centenares de millones eternamente no se puede. ¿La coacción? La excluye el núcleo, y bien excluida está.
...
Una base de usuarios no produce eso. Un pueblo sí. **Un instrumento que funciona con participación voluntaria durante décadas no exige motivación, sino pertenencia**, y esa razón es de ingeniería, no poética.

## Quinta, la jurídica

Los escalones superiores de la influencia - el encaje en un procedimiento ajeno y la conversión de la práctica en norma - están al alcance de quien es alguien, y no de lo que es algo. El instrumento de una empresa se cita, en el mejor de los casos, como fuente; parte no será jamás, porque partes en el derecho internacional lo son los sujetos, y el derecho de libre determinación está reconocido a los pueblos.
...
## A quién le hace más falta esto ya hoy

No al habitante acomodado de un país con instituciones que funcionan: él ya tiene todo eso.
...
## Nueve maneras en que esto no llega a ser

Esta sección no está para equilibrar. Cada uno de los desenlaces enumerados es posible, algunos son más probables que los buenos, y de cada uno se dice qué se hace y qué no garantizamos.
...
Va en tercer lugar, pero por importancia es la primera.
...
**Dónde se cura en realidad.** No en los recordatorios ni en los llamamientos, sino **en la pregunta.** La persona responde cuando la pregunta atañe a su vida y cuando de la respuesta depende algo. De ahí los dos requisitos: la pregunta planetaria se plantea en el punto donde la consecuencia recae sobre la persona, y no allí donde las instituciones la negocian; y ningún período consta solo de preguntas planetarias, porque junto a ellas van siempre las preguntas de la vida interna del pueblo, cuya consecuencia llega enseguida y con certeza.
...
**Qué se hace.** Las dos capas: el panel estudia la cuestión y formula las opciones, y el pueblo vota sobre lo preparado.
...
**Qué ocurre.** Una base verificada de millones de personas únicas se percibe como un problema de seguridad y no como un bien público. Existen precedentes de limitación de proyectos parecidos de verificación de la unicidad en algunas jurisdicciones: véase más arriba el caso de World.
...
[Volver al documento «Voz ciudadana»](https://earth-lings.org/documents/es/es02-voz-ciudadana.html)
