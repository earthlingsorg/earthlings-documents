...
>
> **Fase.** El pueblo Earthlings se constituye mediante la adopción de la Declaración; el período constituyente se extiende desde el 22 de octubre de 2026 hasta la adopción de la Declaración. El contrato del registro de pasaportes, la verificación de identidad, las células y la contabilidad de la economía interna están desplegados y funcionan; el canal público de votación está desplegado, pero todavía no ha habido en él votaciones de fondo, el medio de votación secreta se está eligiendo y los contratos inteligentes de la Tesorería no están desplegados (documento «Dónde estamos ahora»). El llenado de la infraestructura con práctica real empieza a medida que crece el número de participantes. Lo expuesto a continuación describe la construcción jurídica y sus límites, y no una escala alcanzada.
>
> La fundamentación desarrollada está en el documento [Base jurídica](https://earth-lings.org/documents/es/es04-base-juridica.html), y los argumentos contra nuestra posición, en el documento [Objeciones y respuestas](https://earth-lings.org/documents/es/es26-objeciones-y-respuestas.html). En caso de discrepancia se aplican la [Carta de los Earthlings](https://earth-lings.org/documents/es/es05-carta.html) y la [Declaración](https://earth-lings.org/documents/es/es01-declaracion.html).
...
- **el derecho de libre determinación de los pueblos**: artículo 1 común de los Pactos de 1966; como principio está consagrado en la Carta de las Naciones Unidas, artículo 1.2.

Ambas normas están vigentes. Los Pactos de 1966 y el Convenio Europeo son obligatorios para los Estados partes; la Declaración Universal de Derechos Humanos fue adoptada por la resolución A/RES/217(III)A de la Asamblea General y por sí misma no tiene fuerza obligatoria, pero sus disposiciones han pasado a los tratados y a la práctica de los Estados.
...
La existencia del pueblo Earthlings no se hace depender de un acto de reconocimiento: no existe un procedimiento por el que una comunidad voluntaria no territorial pudiera ser reconocida como pueblo, y no hay un registro general de pueblos. Los procedimientos existentes - la lista de territorios no autónomos de las Naciones Unidas, los procedimientos nacionales de reconocimiento de los pueblos indígenas - se apoyan o bien en un territorio o bien en el derecho interno de un Estado concreto, y una comunidad de nuestro género no puede pasar por ninguno de ellos. El pueblo busca la **discernibilidad jurídica**: que se le trate como pueblo allí donde surgen cuestiones concretas, en los foros, en las consultas, en los procedimientos. La discernibilidad se acumula con la práctica, el tiempo, el número de participantes y el trabajo jurídico. Hoy el pueblo está al comienzo de ese camino y no genera todavía normas de derecho internacional.

## Interfaces jurídicas para la relación externa

Para relacionarse con la infraestructura jurídica, administrativa y financiera existente se emplean estructuras jurídicas inscritas en una o varias jurisdicciones: fundaciones, asociaciones y otras formas organizativas.
...
Tras la adopción de la Declaración, las personas que actúan a través de esas estructuras actúan **conforme a una decisión de la Asamblea DAO y dentro de sus límites**; antes de la adopción no hay pueblo, y nadie actúa en su nombre. Allí donde el plazo es más breve que cualquier votación, la Asamblea otorga de antemano un encargo jurídico de defensa (Carta de los Earthlings, artículo 33): es revocable en cualquier momento por mayoría simple, no constituye cargo, no confiere el derecho exclusivo de actuar en nombre del pueblo y está limitado por una lista cerrada de actos admisibles. Las decisiones en nombre del pueblo las adopta únicamente la Asamblea.
...
- actividad mercantil con ánimo de lucro (la cuota paga la verificación de identidad y la emisión del pasaporte - Condiciones de uso, sección 11);
...
La Tesorería dispone de los **fondos comunes** - cuotas de los participantes, detracciones de las células, donaciones - tras la adopción de la Declaración, conforme a decisiones de la Asamblea DAO y con constancia pública de las operaciones. No son fondos de terceros: nadie tiene participación alguna en ellos, la cuota paga la verificación de identidad y la emisión del pasaporte, y cuándo se devuelve está establecido en las Condiciones de uso (sección 11). Hasta la adopción de la Declaración no hay pueblo, y de los fondos dispone el fundador con rendición de cuentas pública (documento «Dónde estamos ahora»); para las operaciones en moneda fiduciaria se emplea una persona jurídica instrumental, que tributa de forma independiente en su jurisdicción.
...
La unidad de cuenta interna del pueblo **no se negocia en ninguna parte**, no está listada en bolsas y no se prepara para listarse; en la cadena no está emitida - las asignaciones se llevan en la contabilidad interna de la plataforma -, no circula y no da votos sea cual sea el saldo en cuenta.
...
No pretende la soberanía, ni el monopolio de la coacción, ni el ejercicio de funciones de poder público en Estado alguno, y no ejerce el derecho de libre determinación mediante la secesión de un territorio, la modificación de las fronteras estatales o la limitación de la soberanía de Estado alguno (Declaración, artículo 7).
...
Los textos del corpus se publican bajo la licencia Creative Commons Attribution 4.0 International (CC BY 4.0): pueden copiarse, distribuirse, traducirse y adaptarse, incluso con fines comerciales, siempre que se reconozca la autoría y se enlace la licencia. Bajo la licencia MIT se publican el código del contrato inteligente del pasaporte con su documentación de arquitectura y las herramientas de compilación del corpus; qué está cerrado y por qué se dice en el documento «Dónde estamos ahora».
