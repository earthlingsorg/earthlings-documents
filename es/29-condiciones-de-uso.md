# Condiciones de uso del pueblo Earthlings
...
- las leyes de su país no se ven afectadas y no se exige renunciar a la nacionalidad;
- el pasaporte acredita la pertenencia y no sustituye a documento alguno.

---

# SECCIÓN 01. Sobre la naturaleza de estas condiciones

La mayoría de las condiciones de uso las escriben empresas para proteger a empresas. Este no es ese documento.

Las presentes condiciones describen cómo se relacionan entre sí los participantes del pueblo: qué derechos tienen y qué obligaciones asumen voluntariamente.

**Lenguaje sencillo.** Evitamos la jerga jurídica siempre que se puede. Si una condición no se entiende, es que está mal escrita.

**Reciprocidad.** No es una lista de limitaciones para usted y de privilegios para nosotros.
...
# SECCIÓN 02. Sobre el pueblo Earthlings
...
# SECCIÓN 03. Pertenencia y registro
...
**Qué se espera:** seguir los principios de la Declaración. La medida de la participación queda a su criterio: no hay actividad obligatoria.
...
## Responsabilidad sobre la cuenta
...
# SECCIÓN 04. Reglas de relación

## Qué se valora

- el respeto a los demás con independencia de su origen, sus opiniones y su identidad;
- la crítica constructiva y el intercambio de ideas;
- la aportación a la obra común: proyectos, iniciativas, ayuda a otros;
- la apertura al diálogo;
- la protección de quienes son vulnerables.

## Qué es inadmisible

- la discriminación por cualquier motivo;
- las amenazas, el acoso y el hostigamiento, incluso encubierto;
- la difusión deliberada de datos falsos;
- el spam, la publicidad insistente, los esquemas fraudulentos;
- los intentos de manipular las votaciones;
- los actos contrarios a los valores de la Declaración.

> **Sobre la libertad de expresión.** Protegemos el derecho a expresar opiniones, incluidas las impopulares, y el desacuerdo con las decisiones del pueblo no acarrea nunca consecuencias. Pero una expresión dirigida a causar daño a una persona concreta ya no es una opinión.
...
# SECCIÓN 05. Contenidos y derechos sobre ellos

## Sus contenidos

Todo lo que usted crea y publica sigue siendo suyo. Al publicar un material, usted autoriza a mostrarlo y difundirlo entre los participantes en el marco del funcionamiento de la plataforma, con indicación de la autoría, incluidas la traducción y las transformaciones técnicamente necesarias. Eso no crea ningún otro derecho, y la autorización cesa junto con la supresión del material.

Recomendamos las licencias abiertas, pero la elección siempre es suya.

## Contenidos de la infraestructura

Los documentos, herramientas y materiales creados por la propia infraestructura se publican bajo licencias abiertas.

## Derechos ajenos

Usted se compromete a no publicar materiales que infrinjan derechos de autor ajenos, a indicar las fuentes al citar, a observar las condiciones de las licencias y a respetar los datos personales de otras personas.

Ante una reclamación fundada, el material controvertido se retira, y su autor recibe aviso y puede objetar.

---

# SECCIÓN 06. El pasaporte
...
> Las marcas de participación que se acumulan en el sistema tienen carácter exclusivamente informativo: no influyen ni en el peso del voto ni en el acceso a ningún papel (Carta, artículo 8).
...
# SECCIÓN 07. La unidad de cuenta

## Naturaleza

Earthlings Coin es una unidad utilitaria de la economía interna. No es una acción, ni un instrumento de inversión, ni una promesa de beneficio.

**Para qué sirve:** pagar servicios dentro del ecosistema, apoyar proyectos, remunerar la aportación.
...
El cumplimiento de la legislación de su país en materia de activos digitales; la tributación de las operaciones; la custodia segura de las claves; la comprensión de los riesgos. Las presentes Condiciones no son asesoramiento fiscal ni de inversión.

---

# SECCIÓN 08. La adopción de decisiones
...
3. **Votación.** Con los umbrales y quórums establecidos en la Carta.
4. **Ejecución.** De manera automática mediante contratos inteligentes o por las estructuras técnicas en ejecución de la decisión.
5. **Transparencia.** El historial de propuestas, debates y resultados es público.

## Qué se decide por votación

Todo lo sustancial: la modificación de la Carta y de las reglas; la distribución de los fondos comunes y la financiación de proyectos; la elección y la revocación de los Core Nodes, del Emergency Multisig y del Consejo Independiente; la limitación de facultades y la suspensión del derecho de voto; las orientaciones estratégicas; las colaboraciones; los parámetros de la plataforma.
...
# SECCIÓN 09. Las células

Las células son equipos pequeños de participantes que trabajan en proyectos concretos: técnicos, educativos, de investigación, culturales, sociales.
...
# SECCIÓN 10. Responsabilidad y sus límites

## Qué nos comprometemos a hacer

- mantener el funcionamiento de la infraestructura;
- proteger los datos conforme a la Política de privacidad;
- informar con transparencia de los problemas y de los cambios;
- atender las comunicaciones en plazos razonables;
- examinar de buena fe las comunicaciones sobre daños documentados relacionados con errores técnicos nuestros y buscar una solución justa.

## De qué responde usted

Del cumplimiento de la legislación de su país; de la seguridad de sus propias claves y credenciales; de las consecuencias de sus actos; de la comprensión de los riesgos de los activos digitales.

## De qué no respondemos

- de los actos de unos participantes hacia otros;
- de la pérdida de sus claves criptográficas, que no se recuperan;
...
# SECCIÓN 11. Cuota, devolución y fallos técnicos

## Naturaleza de la cuota

La cuota se abona una sola vez y cubre el coste del procedimiento: la verificación de identidad y la emisión del pasaporte. **No compra la pertenencia** - esta nace al firmar la Declaración - y no da ni voto ni unidades de cuenta.
...
Las donaciones por encima de la cuota son enteramente voluntarias, no influyen en la condición de earthling y no son reembolsables.
...
# SECCIÓN 12. Derecho aplicable y controversias
...
# SECCIÓN 13. Modificaciones de las Condiciones
...
- ha leído íntegramente las presentes Condiciones;
- entiende su contenido y sus consecuencias;
- está de acuerdo de manera voluntaria y sin coacción;
- ha cumplido 18 años;
- puede asumir tales obligaciones en su jurisdicción.

La versión vigente de las presentes Condiciones, la Declaración, la Política de privacidad y todos los documentos relacionados están permanentemente disponibles en earth-lings.org y abiertos antes de adherirse.

---

**Para cuestiones sobre las presentes Condiciones:** info@earth-lings.org
**Para cuestiones sobre el tratamiento de datos:** privacy@earth-lings.org
