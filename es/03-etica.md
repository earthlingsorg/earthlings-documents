...
# SECCIÓN 01. Resolución de los desacuerdos
...
El primer paso es una conversación directa entre las partes. La mayoría de los desacuerdos se resuelve aquí.

Lo que ayuda: escuchar a la otra parte sin interrumpir; exponer la propia posición mediante hechos y sentimientos propios, y no mediante acusaciones; buscar el interés común detrás de posiciones opuestas; proponer soluciones que tengan en cuenta a ambas partes.

## Fase 2. Mediación

Si el diálogo directo no ha llevado a una solución, las partes pueden acudir a la mediación.
...
El examen se rige por los procedimientos de la Carta. **La Asamblea no puede expulsar a nadie del pueblo en ninguna circunstancia** (Declaración, artículo 10); las medidas aplicables y su procedimiento están establecidos en el artículo 22 de la Carta.
...
- ante hechos constitutivos de delito; tales casos son competencia de los órganos de la jurisdicción correspondiente, y el pueblo no los suplanta.
...
**Respeto a la persona.** Cada cual tiene derecho a su propia opinión, fe, elección y modo de vida. La discriminación, la humillación y el acoso son inadmisibles en el pueblo Earthlings.

**La crítica de las ideas está separada del trato a la persona.** El debate de fondo no se convierte en algo personal.

**Honestidad.** Cada cual puede hacer preguntas y recibir respuestas claras. Emplear al pueblo para manipular o para obtener un provecho personal en perjuicio de lo común es inadmisible.

**La medida de la participación queda a criterio de cada cual.** No existe una actividad obligatoria, y no ser activo no significa nada.

## Prácticas que ayudan

La escucha activa: oír las palabras y también lo que hay tras ellas. Hablar en primera persona en lugar de acusar. Reconocer el propio error sin menoscabo de la propia posición. Agradecer los comentarios recibidos. Concreción: una observación sobre un acto es más útil que un juicio sobre una persona.

Renunciar al sarcasmo y a la pulla en el espacio común hace la conversación más productiva.
...
**La aspereza, la ironía, el desacuerdo y la crítica incómoda no acarrean nunca consecuencias**, ni directamente ni bajo apariencia de otro fundamento (Declaración, artículo 10).

---

# SECCIÓN 03. La confianza

La confianza en el pueblo Earthlings no se apoya en llamamientos, sino en la verificabilidad: apertura de los procedimientos, imposibilidad de acumular poder de manera encubierta, visibilidad de cualquier desviación.

Una confianza así reduce los costes de control y acelera las decisiones. Se sostiene en tres cosas: que la persona entienda cómo funciona el sistema; que los actos y las decisiones sean previsibles; que los errores se reconozcan.

Un error no destruye la confianza si tras él vienen el reconocimiento y la corrección.

---

# SECCIÓN 04. El trabajo en las células

Dentro de una célula rigen la igualdad y la confianza, y cuenta la aportación de todos al resultado.

Las decisiones se adoptan conjuntamente, teniendo en cuenta la opinión de todos los participantes. Las formas de participar son diversas - desde la idea hasta la ejecución - y todas son valiosas.

Cada cual puede cambiar el formato de su participación o salir de la célula sin explicar los motivos y sin reproche. Los acuerdos alcanzados antes siguen siendo cuestión de palabra, pero no son condición de la salida.

La valoración de las aportaciones se hace con criterios abiertos y conocidos de antemano. El resultado conjunto se valora por encima de la superioridad individual.

---

# SECCIÓN 05. Seguridad psicológica
...
# SECCIÓN 06. Relación con el mundo exterior

Un earthling que habla en público habla en nombre propio, salvo que la Asamblea le haya encargado otra cosa.
...
# SECCIÓN 08. Aprendizaje

El pueblo Earthlings ofrece la posibilidad de aprender aquello que hace más fácil el trabajo conjunto: la comunicación no violenta, la conducción de debates, el pensamiento crítico, el reconocimiento de los propios estados de ánimo y de los ajenos.
...
# SECCIÓN 09. Papel del Consejo Independiente

El Consejo ayuda a la comunidad en las cuestiones éticas complejas con recomendaciones públicas y no adopta decisiones vinculantes.
...
# SECCIÓN 10. Modificación del presente documento
