...
**Qué se nos objeta y qué respondemos**

Las objeciones se exponen en su forma más fuerte. A cada una, una respuesta de fondo. Algunas objeciones las consideramos no refutadas, y así se dice allí donde es el caso.

---

## Sobre el documento

Este documento responde a las objeciones sobre la **organización** del pueblo Earthlings: qué es y qué no es, cómo está construido, con el dinero de quién y en nombre de quién habla.

Las objeciones de derecho internacional - sobre el concepto de pueblo, el territorio, el foro, el reconocimiento y los precedentes - no se examinan aquí. Están examinadas en la **Base jurídica**, y repetirlas en dos documentos es garantizarse dos textos divergentes. Donde la cuestión es jurídica, se remite a la sección correspondiente de la Base jurídica.

Las respuestas a las preguntas técnicas, económicas y organizativas están reunidas en el documento «Preguntas frecuentes».

En caso de discrepancia con la Declaración se aplica la Declaración.

**La fase en la que se dice todo esto.** El pueblo definido por un texto adoptado todavía no existe. La Declaración existe como versión inicial y se somete a votación el 17 de febrero de 2027; hasta su adopción la adhesión está suspendida, y quienes han verificado su identidad son participantes en la constitución y no earthlings. El procedimiento está expuesto en el documento «El período constituyente». En todo lo que sigue, allí donde se describen propiedades del pueblo, se habla de una construcción edificada y no de un estado alcanzado.
...
**Tercera.** Las cuestiones de esta clase siempre se han resuelto de la misma manera: por acumulación de práctica verificable. Por eso proponemos que el objeto de la valoración no sea la fuerza del nombre que uno se da, sino la práctica.

---

# I. Qué es esto y qué no es

### Esto es un Estado red, una ciudad chárter o una micronación disfrazada.

Seis delimitaciones, y cada una verificable en los documentos constitutivos: no es un Estado (no hay territorio ni poder coactivo), no es separatismo (no cambia fronteras), no es renuncia a la nacionalidad, no es una jurisdicción paralela (no juzga ni coacciona), no es evasión fiscal, no es anarquismo digital.

Los Estados red aspiran al territorio y a la condición de Estado; los Earthlings deliberadamente no lo hacen. Es otro escalón: la libre determinación de la persona y de su pertenencia, no la construcción de un Estado.

### Esto es separatismo encubierto: hoy «identidad adicional», mañana reivindicación de territorio.

Es imposible por construcción. La libre determinación de los Earthlings, por su propia arquitectura, no puede atentar contra la integridad territorial: el objeto del atentado, es decir, la reivindicación territorial, no existe. Un earthling no le quita nada a su Estado, sino que añade una pertenencia más, planetaria.

La Declaración de Viena de 1993 precisa expresamente que la libre determinación no autoriza a quebrantar la integridad territorial de los Estados que observan el principio de igualdad de derechos y representan a toda la población sin discriminación. La renuncia a las reivindicaciones territoriales está consagrada en la parte intangible de la Declaración Earthlings y no puede ser derogada por mayoría alguna.

El aspecto jurídico de la cuestión está en la Base jurídica, sección 07.
...
**Se verifica que el participante es una persona viva y que es una sola.** La unicidad se comprueba en la verificación de identidad, y esa es una condición de la firma de la Declaración y no un deseo: un pasaporte emitido eludiendo la comprobación se anula (Declaración, artículo 8).
...
**Ningún encargo constituye un cargo.** Toda facultad se revoca de inmediato y con un umbral no superior a aquel con el que se otorgó; la delegación no crea ventaja permanente.
...
Por regla general, así está organizada también la entrada en un pueblo por acto: la naturalización está gravada con una tasa estatal, y también los ciudadanos por nacimiento pagan su pasaporte. La tasa paga el procedimiento, no compra la pertenencia.

La diferencia con el derecho de naturalización es una sola, y está a nuestro favor. Allí quien carece de medios queda exento de la tasa, pero para obtenerla está obligado a declarar su pobreza y a demostrarla ante un órgano que puede no creerle. Aquí no hay exención en absoluto: la cuota se abona siempre íntegra, y solo cambia quién la abona. Quien no puede pagar entra con un solo acto en una cola abierta, donde solo se ven el número y la fecha, y su cuota puede abonarla otra persona o la Tesorería; no hay garantía de ello. Nadie declara nada sobre sí mismo, nadie demuestra nada, y ningún órgano decide si una persona es bastante pobre. Así está organizado el régimen ordinario, en el que la entrada es de pago: en el período constituyente la verificación de identidad es gratuita y la cola no se aplica (documento «El período constituyente»).
...
Al destruirlo, en la cadena queda solo una marca seudónima: el nombre, el documento, la biometría y los hashes de la comprobación no se inscriben en la cadena de bloques en el momento de la emisión. La libertad de asociación no exige el borrado de la historia: la renuncia a una nacionalidad no quema los archivos del Estado, y en la práctica europea sobre los libros parroquiales predomina el modelo de la anotación: el asiento permanece, la condición se marca (Italia, Francia, Irlanda); si ese modelo basta lo está decidiendo ahora el Tribunal de Justicia de la Unión Europea (asunto C-12/25). «Esta persona perteneció al pueblo desde la fecha X hasta la fecha Y» es un hecho del pasado, y no una pertenencia continuada.
...
Por infracciones graves de las reglas comunes hay una sola medida que recae sobre la persona: la advertencia, y no le quita nada, ni la pertenencia, ni el voto, ni el derecho a presentar propuestas, ni el derecho a crear células y a entrar en ellas, ni el acceso a los servicios, ni otra cosa alguna. Las demás recaen sobre un proyecto o una célula conforme a la Carta: pueden alcanzar a los recursos comunes, pero nunca a los derechos de una persona.
...
El derecho de revisión no queda por ello suprimido. Los principios de la parte I de la Declaración - los cinco principales están nombrados en el artículo 11 - no los deroga mayoría alguna. Sus formulaciones y todo el resto del texto de la Declaración los modifica el propio pueblo, por dos tercios de los votos emitidos y con quórum, y solo de modo que ningún principio quede restringido y ninguna garantía a la persona se debilite. Y si realizar la Declaración resulta imposible, los earthlings verificados pueden continuar el pueblo sobre otra base apoyándose en ese mismo registro, que se lleva en la cadena, en las condiciones del artículo 11 de la Declaración, la primera de las cuales es que el núcleo se conserve por completo.
...
Digamos con claridad en qué fase estamos: el texto constitutivo no está adoptado, no hay ni un solo earthling, no hay práctica de autogobierno. El contrato del registro de pasaportes, la verificación de identidad, las células y la contabilidad de la economía interna están desplegados y funcionan; el canal público de votación está desplegado, pero todavía no ha habido en él votaciones de fondo, el medio de votación secreta se está eligiendo y los contratos inteligentes de la Tesorería no están desplegados (documento «Dónde estamos ahora»); el llenado de esa infraestructura con práctica empieza con la adopción del texto. Afirmamos que la construcción funciona, no que se haya alcanzado una escala, y no presentamos una cosa por la otra.
...
La pregunta «qué ocurre si las decisiones no se cumplen» está formulada desde el modelo estatal, donde la decisión está separada de la ejecución y exige coacción. Aquí una parte considerable de las decisiones se autoejecutará: el resultado de la votación lo pone en obra el código, y los pagos por etapas a los proyectos aprobados la Carta los encomienda a un contrato inteligente (artículo 11). No hay desplegado ni un solo contrato inteligente de la Tesorería, y todavía no ha habido votaciones de fondo de la Asamblea (documento «Dónde estamos ahora»). Y allí donde las decisiones son de coordinación, la ausencia de coacción no es un fallo, sino la arquitectura: coaccionar está prohibido por el núcleo propio.

Las diferencias con una «base de usuarios» son observables y verificables, sin una sola autodescripción. Un usuario acepta un contrato de servicio; un earthling firma una declaración de pertenencia a un pueblo cuyo texto estuvo abierto a las propuestas de cualquier persona y fue adoptado por votación de personas verificadas. Los usuarios no tienen derechos de gobierno sobre el operador; aquí cada cual tiene un voto igual, que no se puede comprar, desligado del pago y del capital. Un servicio extrae beneficio de los usuarios; aquí hay un fondo común y un circuito sin ánimo de lucro. Un servicio expulsa a su discreción; aquí la pertenencia es inalienable.

Y lo decisivo: una base de usuarios no puede llevarse la plataforma y marcharse; un pueblo, una vez constituido, sí podrá. El registro de pasaportes vive en la cadena y no en los servidores del operador y, si tras la adopción de la Declaración la realización de esta resulta imposible, los earthlings verificados podrán continuar la existencia del pueblo sobre otra base técnica u organizativa, apoyándose en ese mismo registro (Declaración, artículo 11).

La centralización residual del período constituyente y de la etapa de formación de las estructuras, que comienza con la adopción de la Declaración (Carta, artículo 39), la hemos revelado nosotros mismos, allí mismo, con un plan para reducirla: el adversario cita nuestra propia auditoría. Descalificadora no es: el CICR sigue hoy dirigido por un comité que se coopta a sí mismo y compuesto exclusivamente por ciudadanos suizos, lo que no impide ni su condición de sujeto ni su estatuto de observador ante la Asamblea General de las Naciones Unidas.
...
La instrumentalidad no es, en general, un vicio de los movimientos de libre determinación, sino su definición: el derecho es precisamente su fin. La Declaración de Independencia de los Estados Unidos es un documento de estatus abiertamente instrumental, que enumera de manera expresa las consecuencias jurídicas por las que se declara ese estatus: «declarar la guerra, concertar la paz, contraer alianzas, establecer comercio». Según la lógica de la objeción, 1776 fue una ficción.
...
## Qué queda sin refutar

La buena fe exige reunirlo en un solo lugar y no disolverlo entre las respuestas. Las objeciones jurídicas están reunidas en la Base jurídica; aquí están las relativas a la organización.

**La construcción no está comprobada a escala.** Las respuestas a las tres causas del fracaso de los intentos anteriores de autogobierno están incorporadas a la arquitectura, pero confirmarlas solo puede hacerlo la práctica, y práctica no hay.

**La protección frente a la captura no es completa.** La arquitectura cierra los modos conocidos, no todos. Afirmar más sería faltar a la verdad.
...
**El texto constitutivo no está adoptado.** Hasta la adopción del texto no hay ni un solo earthling, no hay práctica y nadie puede representar al pueblo.

Ninguna de estas circunstancias la damos por resuelta.

---

*La lista está abierta a ampliaciones: a medida que aparezcan nuevas objeciones, el documento se completa. Se puede enviar una objeción por correo a team@earth-lings.org; en el asunto basta una palabra: objeción. Todas las propuestas y respuestas se publican en un registro abierto: <https://github.com/earthlingsorg/earthlings-documents>.*
