...
# Parte I. Diagnóstico: los fallos de «Windows XP»
...
# Parte III. La arquitectura de «Terra 1.0»
...
> La tarea del arquitecto es escribir un sistema que *no necesite arquitecto* y que no permita a nadie llegar a serlo. No ajustar a todos según su criterio, sino suprimir la posición misma de quien ajusta a todos. La mayor función de «Terra 1.0» es la ausencia de un botón que dé a alguien el poder de reescribir a todos los demás.
...
Un modelo no comprobado con un escenario hasta la rotura no es un modelo, sino un decorado. Pasar «Terra 1.0» por tres escenarios duros muestra con honestidad dónde cae.
