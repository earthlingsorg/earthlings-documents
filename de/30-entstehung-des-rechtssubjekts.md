...
Die [Rechtsgrundlage](https://earth-lings.org/documents/de/de04-rechtsgrundlage.html) beantwortet die Frage, ob der Zusammenschluss des Volkes der Earthlings mit dem geltenden Völkerrecht vereinbar ist. Dieses Dokument stellt eine andere, allgemeinere Frage, die nicht an die Earthlings gerichtet ist, sondern an das Recht selbst.
...
Im Juli 2000 nahm die Internationale Romani-Union auf dem Fünften Welt-Roma-Kongress in Prag eine Erklärung der Nation an, die die Roma zu einer nichtterritorialen Nation erklärte. Der Anspruch betraf nicht die Staatlichkeit, sondern die Vertretung - die Möglichkeit, in internationalen Einrichtungen eine eigene Stimme zu haben. In fünfundzwanzig Jahren ist nichts anerkannt worden.

Das rechtliche Hindernis ist in einer Untersuchung des Europäischen Zentrums für die Rechte der Roma benannt - einer Organisation, die diesem Anspruch Erfolg wünschte (Morag Goodwin, „The Romani Claim to Non-Territorial Nation Status“, 2004): Das Recht versteht unter einem Volk die gesamte Bevölkerung eines bereits bestehenden Staates, und eine über viele Staaten verstreute Gemeinschaft fällt nicht unter diesen Begriff. Das zweite Hindernis betrifft den Beweis, und das ist bereits unsere eigene Beobachtung: die Unmöglichkeit festzustellen, wer der Gemeinschaft angehört und wer in ihrem Namen spricht.

**Das zweite Hindernis gehört nicht zum Recht, sondern zur Beweisbarkeit.** Die Mitgliedschaft in einer verstreuten Bevölkerung von Millionen Menschen ließ sich grundsätzlich nicht feststellen - nicht durch ein Verschulden derer, die den Anspruch erhoben, sondern weil es die Mittel dafür nicht gab. Der Anspruch wurde erhoben, doch es gab nichts, was sich zu seiner Stützung vorlegen ließ: kein geprüfter Bestand, keine festhaltbare Praxis der Selbstverwaltung, keine Aufzeichnung, die sich nicht umschreiben ließe.
...
Die beiden oben angeführten Fälle umreißen das unbesetzte Feld von zwei Seiten. Tuvalu zeigt, dass das Recht Status und Gebiet trennen kann, wenn die Notwendigkeit dazu entsteht. Die Roma zeigen, dass bei derselben Frage für ein entstehendes Subjekt die Sache nicht nur an der Norm scheiterte, sondern auch an der Unmöglichkeit, irgendetwas zu beweisen. Es folgen sieben Thesen darüber, warum dieses Feld leer geblieben ist und was es hieße, es zu füllen.

---

## Eine wichtige Klarstellung: was diese Lücke nicht bedeutet

Eine Lücke in der Lehre macht die Entstehung eines Volkes nicht rechtswidrig: Die Rechtmäßigkeit einer Handlung beruht nicht auf dem Vorhandensein einer besonderen Lehre, sondern auf einer geltenden Norm - der Vereinigungsfreiheit, die durch Verträge verankert ist, die schon heute für die Vertragsstaaten verbindlich sind.

Das Fehlen einer ausgearbeiteten Lehre hat nie Rechtswidrigkeit bedeutet: Sonst stünde der erste Fall jeder Rechtsform außerhalb des Rechts, und der Festlandsockel, 1945 beansprucht, als keine einzige Norm einen solchen Anspruch vorsah, wäre ein Rechtsverstoß gewesen und nicht eine künftige Norm. Für Privatpersonen, die eine anerkannte Freiheit ausüben, gilt der Grundsatz „was nicht verboten ist, ist erlaubt“.
...
Die Spezialisierung ist nicht nur am Ton der Lehre sichtbar, sondern an den Texten. Die Resolution 1541 (XV) der Generalversammlung von 1960 legt in ihrem Grundsatz IV fest, dass die Pflicht zur Übermittlung von Angaben prima facie für ein Gebiet besteht, das geografisch abgesondert liegt und sich ethnisch und/oder kulturell von dem Land unterscheidet, das es verwaltet - das Merkmal ist das Gebiet und nicht die Gruppe. Die Resolution 2625 (XXV) von 1970 spricht in ihrer Schutzklausel von einer Regierung, „welche die gesamte Bevölkerung **des Gebiets** ohne Unterschied der Rasse, des Glaubens oder der Hautfarbe vertritt“ - so die deutsche Übersetzung der Vereinten Nationen; der englische Wortlaut, eine der amtlichen Sprachfassungen, ist stärker - „the whole people belonging to the territory“, das ganze Volk, das dem Gebiet angehört. Die Bindung des Volkes an das Gebiet steht hier ausdrücklich im Text.
...
Ein Text, der keine Norm ist, aber als amtliches Dokument der Vereinten Nationen veröffentlicht wurde, verbindet das Volk ausdrücklich mit einem Gebiet: die Studie von Aureliu Cristescu, Sonderberichterstatter der Unterkommission der Vereinten Nationen (1981). Eine Begriffsbestimmung des Volkes gibt sie nicht, nennt jedoch Elemente einer Begriffsbestimmung und sagt von ihnen, sie „können und sollten nicht außer Acht gelassen werden“: Ein Volk ist ein soziales Gebilde mit einer klaren Identität und eigenen Merkmalen und setzt eine Beziehung zu einem Gebiet voraus, **selbst wenn das betreffende Volk zu Unrecht daraus vertrieben und künstlich durch eine andere Bevölkerung ersetzt worden ist**. Die Formulierung erhält einem Volk, das sein Gebiet verloren hat, die Bindung an dieses Gebiet - und den Fall einer Gemeinschaft, die nie eines hatte, behandelt sie nicht. Das ist der genaueste Einwand, den es gibt, und er lässt sich bei der Stellung der Frage nicht umgehen.

Dass eine ausgearbeitete Antwort auf die Frage nach der Entstehung eines Volkes fehlt, zeugt nicht von der Unmöglichkeit einer solchen Antwort: Die Forderung nach ihr wurde erhoben (der oben behandelte Fall der Roma), doch es gab nichts Überprüfbares, womit sie sich hätte stützen lassen.
...
Auf diese Frage antwortet die Rechtsgrundlage bejahend und stützt sich dabei auf die Vereinigungsfreiheit - eine Norm, die durch Verträge verankert ist, die schon heute für die Vertragsstaaten verbindlich sind; keiner dieser Akte stellt eine abschließende Aufzählung zulässiger Formen oder Zwecke eines Zusammenschlusses auf. Ein Verbot einer solchen Handlung enthält das Völkerrecht nicht.
...
Dieses Dokument fügt eine zweite Schicht hinzu: Es zeigt, dass hinter dem einzelnen Fall eine allgemeine Lücke der Lehre steht und dass diese Lücke keine fertige Antwort zu jemandes Gunsten ist, sondern eine natürliche Folge der Geschichte des Rechts selbst.

### Fragen, die zur Erörterung gestellt werden

Wir stellen sie offen und beanspruchen keine fertige Antwort:

- Ist die Bindung an ein Gebiet ein Wesensmerkmal eines Volkes - oder eine geschichtlich vorherrschende Bedingung seiner Bildung? Wenn die Staaten bereits anerkennen, dass der Verlust des Gebiets die Staatlichkeit nicht beendet, welche Arbeit leistet das Gebiet dann bei der Prüfung der Entstehung eines Status?
...
- Ändert es für die rechtliche Beurteilung etwas, dass der Anspruch der Roma nicht nur an der Norm scheiterte, sondern auch an der Unmöglichkeit, irgendetwas zu beweisen?
