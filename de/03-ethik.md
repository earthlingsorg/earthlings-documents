...
> Dieses Dokument ist abgeleitet. Bei einer Abweichung von der [Charta](https://earth-lings.org/documents/de/de05-charta.html) gilt die Charta, und bei einer Abweichung der Charta von der [Erklärung](https://earth-lings.org/documents/de/de01-erklaerung.html) gilt die Erklärung. Die Charta tritt mit der Annahme der Erklärung in Kraft (Charta, Artikel 38); bis dahin gibt es weder eine DAO-Vollversammlung noch einen Unabhängigen Rat, und was unten über sie gesagt wird, beschreibt die Ordnung nach der Annahme.
>
...
Das Folgende zerfällt in zwei Teile, und der Unterschied zwischen ihnen ist wesentlich. Die Regeln zur Beilegung von Streitigkeiten beschreiben ein Verfahren, an das sich das Volk hält. Alles Übrige, ausgenommen die Regeln, die dieses Dokument dem Volk selbst, seinen Organen und der Plattform auferlegt, ist das, wonach das Volk strebt und was es zu lernen hilft; aus einer Abweichung davon treten für einen Menschen niemals Folgen ein.
...
Das Volk der Earthlings wählt einen wiederherstellenden statt eines strafenden Ansatzes: Das Ziel der Behandlung einer Meinungsverschiedenheit ist, die Beziehungen wiederherzustellen und die Folgen zu berichtigen, und nicht zu strafen.
...
**Wer Mediator sein kann.** Jeder Earthling, dem beide Seiten vertrauen und der am Ausgang des Streits kein persönliches Interesse hat; die Seiten einigen sich selbst auf ihn.

**Der Ablauf:**

1. eine der Seiten schlägt der anderen eine Mediation vor;
...
**Vertraulichkeit.** Der Inhalt der Mediation wird weder vom Mediator noch von den Seiten weitergegeben. Die Tatsache ihrer Durchführung und das Ergebnis - ob eine Vereinbarung erzielt wurde oder nicht - werden nur mit Zustimmung beider Seiten veröffentlicht; um die Frage der Vollversammlung vorzulegen, ist eine Seite befugt mitzuteilen, dass eine Mediation stattgefunden und den Streit nicht beigelegt hat, und nichts darüber hinaus.

**Frist.** Dreißig Tage ab der Zustimmung der zweiten Seite; im gegenseitigen Einvernehmen kann die Frist verlängert werden.

**Die Ablehnung einer Mediation zieht nichts nach sich.** Die Unwilligkeit teilzunehmen ist keine Verletzung, wird nicht bewertet und in keiner späteren Behandlung berücksichtigt (Erklärung, Artikel 4).

## Stufe 3. Die Vorlage an die DAO-Vollversammlung

Hat die Mediation zu keiner Beilegung geführt und berührt der Streit die Interessen der Gemeinschaft oder verlangt er eine grundsätzliche Entscheidung, so ist jede der Seiten befugt, die Frage der Vollversammlung zur Behandlung vorzulegen. Fehlt die Zustimmung der anderen Seite zur Mediation, so steht dies dem gleich, dass die Mediation zu keiner Beilegung geführt hat.

Das ist das äußerste Mittel. Es ist angebracht, wenn der Konflikt die Auslegung der Regeln des Volkes betrifft, wenn eine Entscheidung verlangt wird, die ein Vorbild für künftige Fälle setzt, oder wenn das Verhalten einer der Seiten für sich genommen einen Grund nach Artikel 22 oder 22-bis der Charta erfüllt.

Die Behandlung erfolgt nach den Verfahren der Charta. **Einen Menschen aus dem Volk auszuschließen kann die Vollversammlung unter keinen Umständen** (Erklärung, Artikel 4); die anwendbaren Maßnahmen und der Ablauf ihrer Anwendung sind in den Artikeln 22 und 22-bis der Charta festgelegt.

## Was einer Mediation nicht zugänglich ist

Weder ein unmittelbares Gespräch noch eine Mediation finden statt - der Mensch wendet sich unmittelbar, ohne die Stufen 1 und 2 zu durchlaufen, an die Vollversammlung (Stufe 3) oder an die Behörden der jeweiligen Rechtsordnung, an deren Stelle das Volk nicht tritt:
...
Das in diesem Abschnitt Dargelegte ist das, wonach das Volk strebt, wie zu Beginn des Dokuments gesagt. Es begründet keine Pflichten und zieht keine Folgen nach sich.
...
Drohungen, Verleumdung und Nötigung liegen jenseits dieser Grenze, nehmen aber niemandem die Zugehörigkeit zum Volk (Erklärung, Artikel 4). Erfüllt ein solches Verhalten einen in Artikel 22 oder 22-bis der Charta vorgesehenen Grund, so werden die Maßnahmen und das Verfahren dieses Artikels angewandt.
...
Das Volk der Earthlings strebt eine Umgebung an, in der man ohne Furcht eine Idee vorschlagen, sich irren und seine Meinung ändern kann. Angaben über die persönlichen Umstände eines Menschen werden nicht weitergegeben.
...
Beim Wachsen des Volkes in neuen Weltgegenden begegnet das Volk dem örtlichen Zusammenhang und den Überlieferungen mit einer Achtung, die nicht verlangt, einen nach Abschnitt 02 unzulässigen Umgang hinzunehmen. Der Beitritt ist stets freiwillig; kulturelle Unterschiede werden als Bereicherung angesehen und nicht als Hindernis.
...
Die persönlichen Daten der Teilnehmer werden nicht zu geschäftlichen, politischen und beeinflussenden Zwecken verwendet. Die Einwilligung in die Verarbeitung ist bewusst und freiwillig, der Umfang der Daten ist möglichst gering. Einzelheiten stehen in der [Datenschutzerklärung](https://earth-lings.org/documents/de/de28-datenschutzerklaerung.html).

Die Verteilung der gemeinsamen Mittel erfolgt nach den Regeln, die das Dokument [Die Schatzkammer](https://earth-lings.org/documents/de/de09-schatzkammer.html) festlegt, offen und überprüfbar. Dieses Dokument legt keine eigenen Regeln der Verteilung fest.
...
Fehler werden als Teil des Lernens angesehen und nicht als Anlass für eine Ahndung (Erklärung, Artikel 4).
...
Zusammensetzung, Verfahren der Bildung, Gründe des Widerrufs und Bedingungen der Arbeit sind in der [Charta, Artikel 4](https://earth-lings.org/documents/de/de05-charta.html) und im Dokument [Der Unabhängige Rat der Earthlings](https://earth-lings.org/documents/de/de11-unabhaengiger-rat.html) festgelegt.
...
Die Grenzen sind unveränderlich: Nichts in diesem Dokument darf der Erklärung widersprechen, die von ihr gegebenen Gewährleistungen einengen oder Gründe für Maßnahmen über die abschließende Aufzählung der Artikel 22 und 22-bis der Charta hinaus begründen.
