...
# Teil I. Die Diagnose: die Bugs von „Windows XP“
...
# Teil III. Die Architektur von „Terra 1.0“
...
> Die Aufgabe des Architekten ist es, ein System zu schreiben, das *keinen Architekten braucht* und niemandem erlaubt, einer zu werden. Nicht alle nach dem eigenen Verstand einzustellen, sondern die Stellung dessen zu beseitigen, der alle einstellt. Das größte Merkmal von „Terra 1.0“ ist das Fehlen einer Taste, die irgendjemandem die Macht gibt, alle anderen umzuschreiben.
...
Ein Modell, das nicht an einem Bruchszenario geprüft ist, ist kein Modell, sondern eine Kulisse. Der Durchlauf von „Terra 1.0“ durch drei harte Szenarien zeigt ehrlich, wo es fällt.
