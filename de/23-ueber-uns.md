...
**Urheberschaft, Verwaltung, Finanzierung und öffentliche Überprüfung**
...
- Core Nodes - DIENST;
- Emergency Multisig - SICHERHEIT;
- Unabhängiger Rat - BERATUNG.

Die DAO-Vollversammlung, die alle Earthlings umfasst, fasst die bindenden Beschlüsse.

Die Core Nodes sichern die technische Abstimmung auf der Grundlage von Rotation.
...
Die DAO (dezentrale autonome Organisation) bildet den einrichtungsmäßigen Kern der Verwaltung des Volkes der Earthlings.

Die DAO sichert:

- die kollektive Beschlussfassung;
- die durchsichtige Verteilung der Mittel;
- die Abstimmung des Handelns zwischen Earthlings und Zellen;
- das Wirken des Systems ohne zentrale Gewalt.
...
Die ausführliche Beschreibung der Architektur der DAO, der Ebenen der Teilnahme, der Verfahren der Beschlussfassung und der Mechanismen zum Schutz vor einer Übernahme steht im Dokument [Die DAO der Earthlings](/documents/de/de07-dao.html).
...
- den Verkehr mit äußeren Einrichtungen;
- den Abschluss von Verträgen;
- die steuerliche und verwaltungsmäßige Buchführung.

Solche Strukturen dienen ausschließlich als austauschbare betriebliche Mittel des äußeren Verkehrs:

- sie bestimmen das Volk und sein Bestehen nicht;
- sie tragen keine Legitimität und besitzen keine Macht über das Volk;
...
- empfohlene Durchsichten der Beschlüsse der DAO;
- jährliche öffentliche Berichte.

Der Rat besitzt gegenüber den Beschlüssen der DAO kein Vetorecht.
...
## Finanzierung und Durchsichtigkeit

Das Vorhaben ist von Artur Arakelian angestoßen worden; bislang wurde es vollständig aus seinen persönlichen Mitteln finanziert.

Eine äußere Finanzierung ist bislang nicht eingeworben worden.

Die Rechtsstrukturen der Earthlings wirken nicht als Finanzvermittler: Sie erbringen keine Zahlungsdienste, werben keine Mittel Dritter ein und legen keine an und führen keine Handelsvorgänge in jemandes Interesse durch.

Die Einzelheiten sind im Dokument [Die Rechtsgrundlage](/documents/de/de04-rechtsgrundlage.html) dargelegt.
