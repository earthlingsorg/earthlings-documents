...
**Die Stufe, auf der dies alles gesagt wird.** Ein durch einen angenommenen Text bestimmtes Volk gibt es noch nicht. Die Erklärung besteht als Ausgangsfassung und wird am 17. Februar 2027 zur Abstimmung gestellt; bis zu ihrer Annahme ist der Beitritt ausgesetzt, und wer seine Identität hat prüfen lassen, ist Teilnehmer der Konstituierung und kein Earthling. Das Verfahren ist im Dokument „Die Gründungsphase“ dargelegt. Überall im Folgenden, wo Eigenschaften des Volkes beschrieben werden, ist von der gebauten Konstruktion die Rede und nicht von einem erreichten Zustand.
...
Die zweite Folge betrifft die Quelle des Bestehens: Eine Vereinigung ist ein Geschöpf der Rechtsordnung und endet durch deren Akt (Auflösung, Verbot); ein Volk ist eine Tatsache, die sich aus keinem nationalen Rechtsakt herleitet und deshalb durch ihn auch nicht beendet wird. Für eine Gemeinschaft, deren Teilnehmer in Dutzenden Rechtsordnungen leben, ist das eine Architektur des Überlebens, und das Modell austauschbarer juristischer Personen als Träger ist ihre unmittelbare Folge.
...
**Es wird nachgewiesen, dass ein Teilnehmer ein lebender Mensch ist und dass er einer ist.** Die Einmaligkeit wird bei der Identitätsprüfung geprüft, und das ist eine Voraussetzung der Unterzeichnung der Erklärung und kein Wunsch: Ein unter Umgehung der Prüfung ausgegebener Pass wird aufgehoben (Erklärung, Artikel 8).
...
**Kein Auftrag begründet ein Amt.** Jede Befugnis kann unverzüglich und mit keiner höheren Schwelle widerrufen werden, als sie erteilt wurde; einen dauernden Vorteil begründet die Übertragung nicht.
...
Die Vereinigungsfreiheit verlangt eine wirkliche Beendigung der Zugehörigkeit - und hier ist sie vollständiger, als das Recht verlangt: Ein Earthling entwertet seinen Pass selbst, aus der eigenen Geldbörse, kryptografisch; der Server bewahrt keine Schlüssel auf und kann den Austritt weder verhindern noch eine Erlaubnis dafür verlangen.

Bei der Entwertung bleibt in der Kette nur ein pseudonymer Vermerk - Name, Dokument, Biometrie und die Hashes der Prüfung werden bei der Ausgabe nicht in die Blockchain eingetragen. Die Tilgung der Geschichte verlangt die Vereinigungsfreiheit nicht: Der Verzicht auf eine Staatsangehörigkeit verbrennt keine staatlichen Archive, und in der europäischen Praxis zu den Kirchenbüchern überwiegt das Modell der Anmerkung - der Eintrag bleibt, der Status wird vermerkt (Italien, Frankreich, Irland); ob dieses Modell genügt, entscheidet zurzeit der Gerichtshof der Europäischen Union (Rechtssache C-12/25). „Ein Mensch gehörte vom Tag X bis zum Tag Y zum Volk“ ist eine Tatsache der Vergangenheit und keine fortdauernde Zugehörigkeit.
...
Für grobe Verstöße gegen die allgemeinen Regeln gibt es gegenüber einer Person nur eine Maßnahme - die Verwarnung, und sie entzieht nichts: weder die Zugehörigkeit noch die Stimme, noch das Recht, Vorschläge einzubringen, noch das Recht, Zellen zu gründen und ihnen beizutreten, noch den Zugang zu Diensten, noch sonst irgendetwas. Die übrigen Maßnahmen der Charta der Earthlings richten sich an ein Projekt oder eine Zelle: Sie können sich nur auf gemeinsame Mittel beziehen und nicht auf die Rechte einer Person.

Der einzige Fall, in dem ein Pass gegen den Willen seines Inhabers entwertet wird, ist in der Charta der Earthlings erschöpfend benannt und gehört nicht zu den Sanktionen: die Aufhebung einer unwirksamen Ausgabe, wenn festgestellt ist, dass der Pass unter Verstoß gegen die Voraussetzungen der Ausgabe ausgegeben wurde. Der Tod des Inhabers ist kein solcher Grund: Die Zugehörigkeit endet infolge des Todes von selbst, und der Pass bleibt im Register - ein Grund, der sich auf nicht überprüfbare Angaben über einen Tod stützt, wäre der billigste Weg, einen Teilnehmer aus dem Register zu streichen, da Benachrichtigung, Frist für Einwendungen und Beschwerde die Anwesenheit eines Menschen voraussetzen. Die Aufhebung einer unwirksamen Ausgabe ist keine Ausnahme: Sie stellt nur fest, dass die Ausgabe von Anfang an nicht rechtmäßig zustande gekommen ist, und steht dem erneuten Durchlaufen des Verfahrens nicht entgegen.
...
Der Unterschied zu Verfassungsstaaten ist zu unseren Gunsten, und er ist wesentlich. Die Mehrheit der heute lebenden Bürger jedes Landes hat ihrer Verfassung nie zugestimmt: Sie sind in sie hineingeboren. Die Earthlings sind eine Ordnung, in der niemanden ein Text verpflichtet, unter dem nicht seine persönliche, geprüfte Unterschrift steht. Der Kern schützt dabei nicht den Willen des Gründers, sondern die von jedem Unterzeichner erteilte Zustimmung: Einer künftigen Mehrheit zu erlauben, die Werte auszutauschen, hieße alle bereits erteilten Zustimmungen zu täuschen.
...
Das Recht auf Überprüfung ist dabei nicht genommen. Die Grundsätze des Teils I der Erklärung - die fünf wesentlichen unter ihnen sind in Artikel 11 genannt - hebt keine Mehrheit auf. Ihre Formulierungen und den ganzen übrigen Text der Erklärung ändert das Volk selbst - mit zwei Dritteln der abgegebenen Stimmen bei einem Quorum und nur so, dass kein Grundsatz verengt und keine Gewährleistung für den Menschen schwächer wird. Und wird es unmöglich, die Erklärung zu verwirklichen, so sind die geprüften Earthlings befugt, das Volk auf einer anderen Grundlage, gestützt auf dasselbe Register, fortzusetzen, das in der Kette geführt wird - unter den Voraussetzungen des Artikels 11 der Erklärung, deren erste lautet: Der Kern ist vollständig gewahrt.
...
Die Frage, was bei Nichtausführung von Beschlüssen geschieht, ist aus dem staatlichen Modell heraus gestellt, in dem der Beschluss von der Ausführung getrennt ist und Zwang verlangt. Hier wird sich ein erheblicher Teil der Beschlüsse selbst ausführen: Das Ergebnis einer Abstimmung setzt der Code in Kraft, und die Auszahlungen an gebilligte Projekte nach Abschnitten überlässt die Charta einem Smart Contract (Artikel 11). Kein einziger Smart Contract der Schatzkammer ist ausgerollt, und inhaltliche Abstimmungen der Vollversammlung hat es noch nicht gegeben (Dokument „Wo wir jetzt stehen“). Und dort, wo Beschlüsse der Abstimmung dienen, ist das Fehlen von Zwang keine Störung, sondern Bauweise: Zu zwingen verbietet der eigene Kern.

Die Unterschiede zu einer „Nutzerbasis“ sind beobachtbar und überprüfbar, ohne eine einzige Selbstbeschreibung. Ein Nutzer nimmt eine Vereinbarung über eine Leistung an - ein Earthling unterzeichnet eine Erklärung über die Zugehörigkeit zu einem Volk, deren Text für Vorschläge jedes Menschen offenstand und durch die Abstimmung geprüfter Menschen angenommen wurde. Nutzer haben keine Rechte zur Lenkung des Betreibers - hier hat jeder eine gleiche, unkäufliche Stimme, losgelöst von Zahlung und Kapital. Ein Dienst zieht aus Nutzern Gewinn - hier gibt es einen gemeinsamen Fonds und einen nicht gewinnorientierten Aufbau. Ein Dienst schließt nach eigenem Ermessen aus - hier ist die Zugehörigkeit unveräußerlich.

Und das Entscheidende: Eine Nutzerbasis kann die Plattform nicht mitnehmen und gehen - ein Volk wird es können, sobald es konstituiert ist. Das Register der Pässe lebt in der Kette und nicht auf den Servern eines Betreibers, und wird die Verwirklichung der Erklärung nach ihrer Annahme unmöglich, so können die geprüften Earthlings das Bestehen des Volkes auf einer anderen technischen oder organisatorischen Grundlage, gestützt auf dasselbe Register, fortsetzen (Erklärung, Artikel 11).

Die verbliebene Zentralisierung der Gründungsphase und der Phase des Strukturaufbaus, die mit der Annahme der Erklärung beginnt (Charta, Artikel 39), haben wir selbst offengelegt, an derselben Stelle, mit einem Plan ihres Abbaus - der Gegner zitiert unsere eigene Prüfung. Ein Ausschlussgrund ist sie nicht: Das Internationale Komitee vom Roten Kreuz wird bis heute von einem sich selbst ergänzenden Komitee ausschließlich schweizerischer Staatsangehöriger geleitet, was weder seiner Subjektstellung noch seinem Beobachterstatus bei der Generalversammlung der Vereinten Nationen entgegensteht.
...
Zweckhaftigkeit ist überhaupt kein Makel von Selbstbestimmungsbewegungen, sondern ihre Bestimmung: Das Recht ist eben ihr Ziel. Die Unabhängigkeitserklärung der Vereinigten Staaten ist ein offen zweckhaftes Statusdokument, das die rechtlichen Folgen, um derentwillen der Status erklärt wird, unmittelbar aufzählt: „Krieg zu erklären, Frieden zu schließen, Bündnisse einzugehen, Handel zu treiben“. Nach der Logik des Einwands wäre das Jahr 1776 eine Fiktion.

Und das Wichtigste: Das subjektive Merkmal ist das Selbstverständnis einer Gruppe, und eine Gruppe ist keine Strategie eines Gründers, sondern sind Menschen, von denen jeder eine persönliche Handlung vorgenommen hat. Ein gewöhnlicher Teilnehmer hat nichts nachzuahmen: Die Stimme ist unkäuflich, der Fonds ist nicht gewinnorientiert - einen Kanal privater Bereicherung gibt es baulich nicht. Eine Nachahmung wäre ein fehlender Wille: Unterschriften ohne Menschen, ein totes Register. Die Zielgerichtetheit eines Willens kann das Merkmal des Willens nicht verfehlen.
...
**Der konstituierende Text ist nicht angenommen.** Bis zur Annahme des Textes gibt es keinen einzigen Earthling, keine Praxis, und niemand kann das Volk vertreten.
