# Die Nutzungsbedingungen des Volkes der Earthlings

**Treten mit der Veröffentlichung in Kraft**

> Weichen diese Bedingungen von der [Charta](https://earth-lings.org/documents/de/de05-charta.html) ab, so gilt die Charta, und weicht die Charta von der [Erklärung](https://earth-lings.org/documents/de/de01-erklaerung.html) ab, so gilt die Erklärung. Die Verarbeitung der Daten ist in der [Datenschutzerklärung](https://earth-lings.org/documents/de/de28-datenschutzerklaerung.html) beschrieben.
...
- die Gesetze Ihres Landes werden nicht berührt, ein Verzicht auf die Staatsangehörigkeit wird nicht verlangt;
- der Pass weist die Zugehörigkeit nach und ersetzt keine Papiere.

---

# ABSCHNITT 01. Zur Natur dieser Bedingungen

Die meisten Nutzungsbedingungen sind von Unternehmen zum Schutz von Unternehmen geschrieben. Das ist kein solches Dokument.

Diese Bedingungen beschreiben, wie die Teilnehmer des Volkes miteinander umgehen: welche Rechte sie haben und welche Pflichten sie freiwillig übernehmen.

**Einfache Sprache.** Wir vermeiden juristische Fachsprache überall dort, wo es möglich ist. Ist eine Bedingung unverständlich, so ist sie schlecht geschrieben.

**Gegenseitigkeit.** Das ist keine Aufzählung von Beschränkungen für Sie und von Vorrechten für uns.
...
# ABSCHNITT 02. Über das Volk der Earthlings
...
**Was erwartet wird:** das Befolgen der Grundsätze der Erklärung. Das Maß der Teilnahme bleibt Ihrem Ermessen überlassen: Eine verbindliche Aktivität gibt es nicht.
...
## Die Verantwortung für das Konto
...
# ABSCHNITT 04. Die Regeln des Umgangs

## Was begrüßt wird

- Achtung vor anderen unabhängig von Herkunft, Ansichten und Identität;
- sachliche Kritik und Austausch von Gedanken;
- der Beitrag zur gemeinsamen Sache - Projekte, Anregungen, Hilfe für andere;
- Offenheit für das Gespräch;
- der Schutz derer, die verwundbar sind.

## Was unzulässig ist

- Diskriminierung aus jedem Grund;
- Drohungen, Verfolgung, Anfeindung, auch verdeckte;
- die absichtliche Verbreitung falscher Angaben;
- Spam, aufdringliche Werbung, betrügerische Vorhaben;
- Versuche, Abstimmungen zu beeinflussen;
- Handlungen, die den Werten der Erklärung widersprechen.

> **Zur Meinungsfreiheit.** Wir schützen das Recht, Meinungen zu äußern, auch unbeliebte, und die Ablehnung von Beschlüssen des Volkes zieht niemals Folgen nach sich. Doch eine Äußerung, die darauf gerichtet ist, einem bestimmten Menschen Schaden zuzufügen, ist keine Meinung mehr.
...
# ABSCHNITT 05. Inhalte und die Rechte daran

## Ihre Inhalte

Alles, was Sie schaffen und veröffentlichen, bleibt Ihres. Mit der Veröffentlichung eines Materials gestatten Sie seine Anzeige und Verbreitung unter den Teilnehmern im Rahmen der Arbeit der Plattform, unter Angabe der Urheberschaft, einschließlich der Übersetzung und technisch notwendiger Umformungen. Weitere Rechte begründet das nicht, und die Gestattung endet mit der Löschung des Materials.

Wir empfehlen offene Lizenzen, doch die Wahl liegt stets bei Ihnen.

## Die Inhalte der Infrastruktur

Dokumente, Werkzeuge und Materialien, die von der Infrastruktur selbst geschaffen wurden, werden unter offenen Lizenzen veröffentlicht.

## Fremde Rechte

Sie verpflichten sich, keine Materialien zu veröffentlichen, die fremde Urheberrechte verletzen, beim Zitieren die Quellen anzugeben, die Bedingungen der Lizenzen zu beachten und die persönlichen Daten anderer Menschen zu achten.

Bei einer begründeten Beschwerde wird das strittige Material entfernt, und der Verfasser wird benachrichtigt und ist befugt zu widersprechen.

---

# ABSCHNITT 06. Der Pass
...
> Die Vermerke über die Teilnahme, die sich im System ansammeln, haben ausschließlich Auskunftscharakter: Sie wirken sich weder auf das Gewicht der Stimme noch auf den Zugang zu irgendeiner Rolle aus (Charta, Artikel 8).
...
# ABSCHNITT 07. Die Recheneinheit

## Die Natur

Earthlings Coin ist eine Nutzungseinheit der inneren Wirtschaft. Das ist keine Aktie, kein Anlagewerkzeug und kein Versprechen von Gewinn.

**Wofür:** die Bezahlung von Leistungen innerhalb des Ökosystems, die Unterstützung von Projekten, die Vergütung für Beiträge.
...
Näheres steht im Dokument [Earthlings Coin](https://earth-lings.org/documents/de/de10-earthlings-coin.html).

## Ihre Verantwortung

Die Beachtung des Rechts Ihres Landes in Bezug auf digitale Vermögenswerte; die Besteuerung der Vorgänge; die sichere Aufbewahrung der Schlüssel; das Verständnis der Risiken. Diese Bedingungen sind keine Steuer- und keine Anlageberatung.

---

# ABSCHNITT 08. Die Beschlussfassung
...
3. **Die Abstimmung.** Nach den Schwellen und Quoren, die die Charta festlegt.
4. **Die Ausführung.** Selbsttätig durch Smart Contracts oder durch die technischen Strukturen in Ausführung des Beschlusses.
5. **Die Durchsichtigkeit.** Die Geschichte der Vorschläge, der Erörterungen und der Ergebnisse ist öffentlich.

## Was durch Abstimmung entschieden wird

Alles Wesentliche: die Änderung der Charta und der Regeln; die Verteilung gemeinsamer Mittel und die Finanzierung von Projekten; die Wahl und der Widerruf der Core Nodes, des Emergency Multisig und des Unabhängigen Rates; die Beschränkung von Befugnissen und die Aussetzung des Stimmrechts; die strategischen Richtungen; die Partnerschaften; die Kennwerte der Plattform.

## Ihre Rechte

- über alle Fragen abzustimmen;
- Vorschläge einzubringen;
- die Stimme in einem einzelnen Sachgebiet einem anderen Teilnehmer zu übertragen und **die Übertragung in einem Schritt zu widerrufen**, ohne Angabe von Gründen und ohne seine Zustimmung; eine Übertragung für alle Fragen zugleich ist nicht möglich, Ketten sind verboten, die Obergrenze und die Aufzählung der Fragen ohne Übertragung legt Artikel 7 der Charta fest;
- die gesamte Geschichte der Beschlüsse einzusehen;
- Beschlüsse anzufechten, die den unabänderlichen Kern der Erklärung verletzen.
...
# ABSCHNITT 09. Die Zellen

Zellen sind kleine Teams von Teilnehmern, die an bestimmten Projekten arbeiten: an technischen, bildenden, forschenden, kulturellen, gesellschaftlichen.
...
Der Austritt aus einer Zelle ist stets frei und wirkt sich weder auf die Zugehörigkeit zum Volk noch auf das Stimmrecht aus. Näheres steht im Dokument [Die Zellen der Earthlings](https://earth-lings.org/documents/de/de08-zellen.html).

---

# ABSCHNITT 10. Die Haftung und ihre Grenzen

## Wozu wir uns verpflichten

- die Funktionsfähigkeit der Infrastruktur zu erhalten;
- die Daten nach der Datenschutzerklärung zu schützen;
- über Probleme und Änderungen durchsichtig zu berichten;
- Anfragen in angemessenen Fristen zu behandeln;
- Anfragen über aufgezeichneten Schaden, der mit unseren technischen Fehlern zusammenhängt, redlich zu behandeln und eine gerechte Lösung anzustreben.

## Wofür Sie haften

Die Beachtung des Rechts Ihres Landes; die Sicherheit der eigenen Schlüssel und Zugangsdaten; die Folgen der eigenen Handlungen; das Verständnis der Risiken digitaler Vermögenswerte.

## Wofür wir nicht haften

- die Handlungen von Teilnehmern gegenüber einander;
- den Verlust Ihrer kryptografischen Schlüssel - sie werden nicht wiederhergestellt;
...
# ABSCHNITT 11. Beitrag, Rückerstattung und technische Störungen

## Die Natur des Beitrags

Der Beitrag wird einmal entrichtet und deckt die Selbstkosten des Verfahrens: der Identitätsprüfung und der Ausgabe des Passes. Er **kauft keine Zugehörigkeit** - sie entsteht durch die Unterzeichnung der Erklärung - und gibt weder eine Stimme noch Recheneinheiten.
...
Spenden über den Beitrag hinaus sind vollständig freiwillig, wirken sich auf den Status nicht aus und werden nicht erstattet.
...
# ABSCHNITT 12. Anwendbares Recht und Streitigkeiten
...
# ABSCHNITT 13. Änderungen dieser Bedingungen
...
- diese Bedingungen vollständig zur Kenntnis genommen haben;
- ihren Inhalt und ihre Folgen verstehen;
- freiwillig und ohne Zwang zustimmen;
- das Alter von 18 Jahren erreicht haben;
- befugt sind, solche Verpflichtungen in Ihrer Rechtsordnung zu übernehmen.

Die geltende Fassung dieser Bedingungen, die Erklärung, die Datenschutzerklärung und alle damit zusammenhängenden Dokumente stehen auf earth-lings.org dauerhaft zur Verfügung und stehen vor dem Beitritt offen.

---

**Für Fragen zu diesen Bedingungen:** info@earth-lings.org
**Für Fragen zur Verarbeitung der Daten:** privacy@earth-lings.org
