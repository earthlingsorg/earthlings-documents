...
There are no other conditions of belonging. **The one-time contribution** - the equivalent of 79 USD - covers identity verification, the issuance of the passport, and the upkeep of the infrastructure, and is not a condition of belonging. Whoever cannot make it themselves may join an open queue, and the contribution for them may be made by another person or by the Treasury, but there is no guarantee that it will be; no exemption from the contribution is provided for, and the contribution is paid in full in any event (Charter, Article 12 bis).
...
**What the administration may do without a decision of the Assembly.** Two actions only. The first is to suspend access to an account where there are clear signs of the account being compromised or subjected to a technical attack - with immediate notice to the participant and subsequent consideration by the Assembly; this protects your account, is not a measure of liability, and does not affect a participant's rights. The second is to suspend an account if it becomes known that a person under the age of 18 has registered (Privacy Policy, section 10); in that case the passport is burned either by the holder themselves or under the procedure for annulment of an invalid issuance (Charter, Article 21).
...
4. in extreme cases - if mediation has failed and the dispute affects the interests of the community or calls for a decision of principle - either party is entitled to refer the question to the Assembly.
