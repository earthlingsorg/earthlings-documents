...
Identity verification and the issuance of a passport are covered by a one-time contribution on joining. The contribution covers cost price, buys no belonging, and creates no advantage of any kind (Declaration, Article 8). The amount of the contribution is set by the Assembly; it may be increased only by a decision of the Assembly.
