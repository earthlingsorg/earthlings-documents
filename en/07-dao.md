...
There is no single centre of governance. Decisions are taken in distributed fashion: through the participation of Cells, the voting of participants, and procedural mechanisms. This lowers the risk of capture and makes the system resilient to local failures.
...
The requirements as to majority and quorum depend exclusively on the subject matter of the decision and are fixed by the Charter. Neither working groups, nor the Independent Council, nor any other structure changes thresholds or can change them.
