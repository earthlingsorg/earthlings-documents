...
**Current state.** The passport registry contract, identity verification, Cells, and the accounting of the internal economy are deployed and working; the public voting channel is deployed, but no substantive votes have yet been held in it, a tool for secret voting is being chosen, and the Treasury smart contracts have not been deployed (the document "Where We Are Now"). What has not been adopted is the founding text.
...
3. no fewer than thirty per cent of the total number of confirmed participants as at the day of the vote took part in the vote; only holders of a valid temporary document are included in that total.
