...
对技术、经济和组织方面问题的答复，收在《常见问题》文件中。

与《宣言》有分歧时，适用《宣言》。

**说这一切时所处的阶段。** 由已通过的文本所确定的人民，目前尚不存在。《宣言》作为初始版本存在，并将于二〇二七年二月十七日提交表决；在它通过之前，加入处于暂停状态，而已通过身份验证的人是创立的参与者，还不是 earthlings。程序载于《创立期》文件。以下凡是描述人民属性之处，说的都是已经建成的制度设计，而不是已经达到的状态。

**所有答复共同归结到的出发点：**

**第一。** 我们所依据的两项规范今天都有效：结社自由和人民自决权。确立这些规范的条约对其缔约国有拘束力。其中没有一项是杜撰出来的。
...
相加的自决立在构造的四项属性之上。归属而非管辖：既没有领土，也没有对空间、资源或国家居民的管辖权。言语而非强力：没有任何武装的或强制性的组织。立场而非权力：不征税，不行使刑事管辖权，不管制经济。附加而非取代：在准据法冲突时，优先适用本国法域的强制性规范。
...
**得到验证的是：参与者是活着的人，并且只有一个。** 唯一性在身份验证时受到检验，而这是签署《宣言》的条件，不是一项愿望：绕过验证发放的护照将被注销（《宣言》第八条）。

**根基被置于投票的范围之外。** 归属、票的平等、退出的权利，以及带有保障的价值，根本不付诸投票——这不是提高门槛的问题，而是根本不在选票上的问题（《宣言》第三条、第四条、第五条）。

**组织不参与。** 归属于人民的只能是活着的人；法人不得加入，不得取得票，也不得积累影响力。

**任何受托事项都不构成职务。** 任何权限都可以立即撤回，撤回的门槛不高于授予它时的门槛；转交并不产生长久的优待。
...
归属由一项免费的行为创立——签署《宣言》。会费覆盖程序的成本——身份唯一性的验证和 Earthlings 护照的发放——并支持人民的基础设施：它进入共同资金，并按公布的份额分配。另外说明，身份验证**在创立期是免费进行的**：在文本通过之前，任何人都不缴纳任何费用。

一般来说，以行为加入人民的入口也正是这样安排的：入籍要缴纳国家规费，而护照对因出生而取得国籍的公民也是收费的。规费支付的是程序，而不是购买归属。

与入籍法的差别只有一点，而这一点对我们有利。在那里，无力支付的人可以免缴规费——也就是必须声明自己贫困，并向一个有权不相信他的机关加以证明。我们这里根本没有免缴：会费任何时候都全额缴纳，不同的只是缴纳的人。缴不起的人只需一个动作就进入公开的排队，队列中只显示号码和日期，他的会费可以由另一个人或者司库缴纳；对此没有保证。没有人需要申报关于自己的任何事情，没有人需要证明任何事情，也没有任何机关来决定一个人是否足够贫困。这是入口收费的主要制度；在创立期内身份验证免费，排队不适用（《创立期》文件）。
...
我们同时不作的承诺是：一定会有人来付。排队的人要等待 Earthlings 护照的发放，而要等多久，事先无从知道：代为缴纳是可能的，但没有保证——我们在这里看到的是对可能之事的诚实划界，而不是贫困问题的解决。归属并不取决于此：归属因签署《宣言》而产生，而不是因会费而产生。
...
销毁之后，链上只留下一个化名的标记——发放时姓名、证件、生物特征和验证的哈希值都不写入区块链。结社自由并不要求抹去历史：放弃国籍并不会烧掉国家档案，而欧洲关于教会登记簿的实践以附注的模式为主——记录保留，状态加以标注（意大利、法国、爱尔兰）；这一模式是否足够，欧盟法院正在审理（C-12/25 号案件）。“某人自 X 日至 Y 日归属于人民”是过去的事实，而不是持续的归属。
...
对于严重违反共同规则的行为，针对个人的措施仅有一项——警告，而它不剥夺任何权利：既不剥夺归属和一票，也不剥夺提出建议的权利、创建或加入蜂巢单元的权利、使用各项服务的权利以及其他一切权利。其余的措施，宪章把它们指向项目或者蜂巢单元：它们可以涉及共有资源，不得涉及个人权利。
...
有一点保留是我们自己说出来的。销毁的法律根据被穷尽地限定，但在已部署的合约版本中，所有者密钥的持有人在技术上仍然能够销毁护照：宪章第二十一条的限制是程序上的，而不是技术上的；在《宣言》通过之前，既没有理事会，也没有全体大会（宪章第三十八条），而创立的参与者的临时证件违背持有人意愿被销毁时，依《创立期》文件的程序（第二部分第 5 点）进行。发放权与销毁权的分离、执行的延时，以及把所有权移交给多重签名，都已列入路线图。

### 你们的“不可修改的核心”是创立者在人民产生之前写的。这不是自决，而是加入别人的文本。

**核心尚未通过，在通过之前对任何人都不生效。**

自二〇二六年十月二十二日至二〇二七年一月二十日，文本开放供人提出建议——而且不只是《宣言》，而是整个文集，包括《法律依据》和本文件。任何人都有权提出建议：为此不需要加入，不需要通过身份验证，也不需要同意我们的结论，匿名的建议与其余建议同等审议。每一项建议连同答复一并公布——被采纳的和被否决的都公布，并说明否决的理由。二〇二七年二月三日公布汇总和最终文本。二〇二七年二月十七日，文本由已通过身份验证的活着的人依照“一人一票”的原则投票通过，门槛为三分之二，并有法定人数的要求。整个程序，包括创立期内权限的界限，由《创立期》文件规定。
...
与此同时，修改的权利并没有被拿走。《宣言》第一部分的各项原则——其中主要的五项列举于第十一条——任何多数都不得取消。它们的表述以及《宣言》其余的全部文本，由人民自己修改——以所投票数的三分之二并有法定人数的要求，并且只能以不收窄任何一项原则、不削弱任何一项对人的保障的方式修改。而如果《宣言》的实施变为不可能，经确认的 earthlings 有权依据链上维护的同一份名册，在另一种基础上把人民延续下去——条件由《宣言》第十一条规定，其中第一项是：核心被完整保留。

保持不变的，是保护人免受人民自身权力侵害的那些内容。其余一切人民都有权改正，包括我们的错误：无法修改的文本会把错误永远保存下来，而可以整个重写的文本什么也保护不了。

### 你们的机构是能运行的软件，而不是能运行的自治。在法律上你们是基金的用户群。

我们直接说明所处的阶段：创立文本尚未通过，一个 earthling 也没有，没有自治的实践。护照名册合约、身份验证、蜂巢单元和内部经济的记账已经部署并在运行；公开的投票渠道已经部署，但其中还不曾有过有实质内容的投票，秘密投票的手段正在选定，而司库的智能合约尚未部署（《我们现在在哪里》文件）；用实践去充实这套基础设施，要从文本通过之日开始。我们主张的是这一制度设计能够运转，而不是已经达到的规模，我们也不把两者混为一谈。

而效能是与主张的大小相称地衡量的，法律也从容地承认小型共同体的行为能力。

“决定得不到执行会怎样”这个问题，是从国家模型里提出来的：在那里决定与执行相分离，并且需要强制。这里有相当一部分决定将是自我执行的：投票的结果由代码付诸实施，而向已批准项目按阶段的拨付，宪章交给了智能合约（第十一条）。司库的智能合约一个也没有部署，全体大会也还不曾有过有实质内容的投票（《我们现在在哪里》文件）。而在决定属于协调性质的地方，没有强制并不是故障，而是制度设计：强制为其自身的核心所禁止。

与“用户群”的区别是可以观察、可以验证的，无须任何自我描述。用户接受的是服务协议——earthling 签署的是关于归属于人民的宣言，而这份文本曾向任何人开放接受建议，并由已通过身份验证的人投票通过。用户对运营者没有治理的权利——这里每个人都有平等的、买不到的、与付款和资本脱钩的一票。服务从用户身上取得利润——这里是共同资金和非营利的架构。服务按自己的裁量开除用户——这里归属不可让渡。

而决定性的一点是：用户群无法把平台拿走然后离开——人民在创立之后可以。护照名册存在于链上，而不是在运营者的服务器上；如果《宣言》通过之后它的实施变为不可能，经确认的 earthlings 可以依据同一份名册，在另一种技术基础或者组织基础上把人民延续下去（《宣言》第十一条）。

创立期以及随《宣言》通过而开始的机构形成阶段（宪章第三十九条）所残留的集中，是我们自己在同一处披露的，并附有缩减它的计划——对方引用的正是我们自己的审计。这并不构成取消资格的理由：红十字国际委员会至今仍由一个自我增补的、成员全部为瑞士公民的委员会管理，而这既不妨碍它的主体性，也不妨碍它在联合国大会的观察员地位。
...
工具性根本不是自决运动的缺陷，而是它们的定义：法律正是它们的目的。《美国独立宣言》是一份公开具有工具性的地位文件，它直接列举了宣告这一地位所要取得的法律后果：“宣战、缔结和平、结成同盟、开展通商”。按照这条反对意见的逻辑，一七七六年也是拟制。
...
依据是人类共同继承财产的学理，它已经就海底（《联合国海洋法公约》第一百三十六条）和月球（一九七九年《月球协定》第十一条）得到确立：它容许作为整体的人类的利益，却不创设由人本身组成的承载者：在“区域”内为全人类行事的是管理局，而管理局的成员是《公约》的缔约国（第一百三十七条第二款和第一百五十六条）。
...
**创立文本尚未通过。** 在文本通过之前，一个 earthling 也没有，没有实践，也没有任何人能够代表人民。
