...
> **我们无法代您销毁护照。**宪章（第二十一条）只在两种情形下允许违背持有人意愿的销毁——依全体大会的决定注销无效的发放，以及依您本人的申请作技术性重新发放。撤回同意不在其中，而且平台不保存您的密钥。如果您撤回同意而不销毁护照，我们会删除自己一方的数据，但账本之中的记录将一直留存，直到您把它销毁。
...
修改的程序——不少于三十天的事先通知、修改清单的公布以及提出异议的权利——由《隐私政策》确立。
