...
> 本文件展开《宣言》中的一项规定。第六条说，Earthlings 人民形成其 earthlings 的可验证集体立场，并把这一立场传达给国家和国际组织。这一立场的力量不取决于人民的权限，而取决于人的自由参与、程序的透明和验证结果的可能。
>
...
测量需要一个确定的构成——否则就不知道所说的比例是相对于什么而言的。运营者不应当有能力改变这一构成——这就意味着参与者对运营者拥有权利，而这是一份创立文本，不是用户协议。仪器不应当是可以买到的——这就意味着它没有所有人，由参与者来治理。它应当对各方都适用——这就意味着它不属于任何一个国家。并且，在公布结果的时候，它说的是“我们”，而不是“某项服务的多少名用户”。
...
也许有人觉得，没有权限就无法产生影响。这不正确，而且被实践所推翻。下面是六个案例——四个成功的，两个失败得很有教益的。我们援引它们，不是作为我们正确的证明，而是作为对我们自己提出要求的来源。
...
上面所描述的仪器是一个构想。这里说的是它应当怎样运作，才不至于变成又一次民意调查。[宪章](https://earth-lings.org/documents/zh/zh05-charter.html)第八条之一规定了没有它们测量就不成立的那些要求：谁无权批准问题，什么与结果一同公布，谁决定是否存在缺陷，以及不得用谁的钱进行测量。详细的程序，宪章交由全体大会决定，并要求在第一次测量之前公布；截至今日尚未通过。下面是同样的内容，并说明每一项要求从何而来，以及在还没有规则的地方是怎样的构想。
...
界线本身是封闭的，问题的清单则不是。落入其中的，例如有：跨国利润的征税、人工智能系统的规则、大气与海洋的命运、对大流行病的韧性、对后代所负的责任。个别国家的内部政治则一概不落入其中——这一点在第十一节另行说明。

### 问题必须关系到被问者的生活

这是对最可能导致失败的原因——投票率低——的回答，投票率低在第二十节另有说明。它不靠提醒、也不靠号召来医治，而靠问题。**如果问题不关系到人们真实的生活、利益和困难，投票的意义就整个消失了：既没有必要问，也没有必要答。**

这里有一个真实的矛盾，而我们把它说出来，不绕开它。这道界线所筛选出来的是全球性问题——那些涉及所有人的问题。而全球性的东西听起来离人很远：在“跨国利润税率的协调”与具体某一天的操心之间，距离仿佛无法跨越。

只是仿佛而已。全球性问题**总要落到某个地方**——否则它就不是全球性的：涉及所有人的事情，也就涉及每一个人。这就是说，问题应当提在落地的点上，而不是提在谈判的点上。请比较：
...
第二道界线是第五条。离人最近的问题几乎总是内部政治的问题，而正因如此它们被关闭。合用的问题落在两个条件的交集之中：**它关系到人的生活，同时又没有国家层面的地址。** 这个交集不是空的：跨国利润的征税、人们每天与之对话的那些系统的规则、关于人的数据的命运、药品的价格、对大流行病的韧性、谁为对地球造成的损害付费。它们每一个在任何人的生活里都有一个落地点，而且没有任何一个议会能够把它整个解决。
...
**人民内部生活的问题**——共同资金花在什么上、会费是多少、支持哪些项目、规则如何变更、受托事项怎么处理。这里的后果总是立即发生：钱确实被花掉，规则确实被改变。正是这些投票养成作答的习惯，而习惯是长距离上维持投票率的唯一依靠。它们的对象不由第六条限定，而由[《宣言》](https://earth-lings.org/documents/zh/zh01-declaration.html)第九条限定：这是人民生活的问题，不是人民对外立场的问题。
...
对它的回答是双层结构。下面描述的是[宪章](https://earth-lings.org/documents/zh/zh05-charter.html)第八条之二规定的程序；它今天无论如何也无法适用——从几百人的名册中抽签，得不到人民的横截面，而该条本身就这样写明。这一程序是这样构造的：
...
最后一项是最主要的。**核实不应当要求相信我们。** 一票是秘密的（《宣言》第九条），而核实的构造使它不被揭示：计票的正确性依据公开数据、由公开的软件来证明，不揭示谁投了票以及如何投票。我们既不能添加一票，也不能伪造他人的票，而这一点不靠我们的话来验证，靠的是别人的重新计算。

现在的情况如何，我们自己说出来。秘密投票的手段还没有，正在选定，而二〇二七年二月十七日关于通过《宣言》的投票将秘密进行。在已经部署的公开的投票渠道中，票由钱包签名，投票者的地址是公开的，而投票时的投票权由我们的服务器确认；其中没有进行过实质性的测量。同样的话也直接写在[我们现在在哪里](https://earth-lings.org/documents/zh/zh32-where-we-are-now.html)之中，那里还指出了今天还得相信我们的那些地方。
...
**这不代替国籍、选举和法律。** earthling 仍然是自己国家的公民，在它的选举中投票，遵守它的法律，缴纳它的税。人民不要求、也不能要求别的：归属是补充，而不是替代——[《宣言》](https://earth-lings.org/documents/zh/zh01-declaration.html)第八条。
...
由这条规范可以生长出一道常设程序：对每一项重要决定就其对后来者的影响作出评估，并公布结论，任何参与者都有权要求作出这样的评估。据我们所知，这样的程序今天在任何国家和任何国际组织中都不存在。与之最接近的是威尔士的未来世代专员和芬兰议会的未来委员会，但两者都不评估每一项重要决定，也不赋予任何参与者要求作出这种评估的权利。我们这里也还没有：有的是它由之而来的那条规范，而这是两回事（第二十一节）。
...
*社团已经不够了：它的设立文件可以由它自己的多数成员改写。*

**第四步。** 仪器应当比建造它的人活得更久，而且不是可以买到的。可以买到的东西，早晚会被买走，而买主继承了测量的权利。凡是以信任为资本的机构，在换了所有人之后还保住这份信任的，很少。
...
- 公开的投票渠道，其中每一票都由投票人的钱包签名；这些票是公开的；
- 链上的共同资金，其每一笔交易都可供公开审计。

**尚未建成的：**

- **实质性的测量没有进行过。** 投票渠道已经部署并且在技术上运转，但其中还没有过实质性的投票；《宣言》第九条要求秘密投票，而秘密投票的手段还没有，正在选定；
- **详细的问题形成程序不存在。** 宪章第八条之一规定了没有它们测量就不成立的那些要求；详细的程序交由全体大会决定，而尚未通过；
- **由抽签组成的审议小组不存在。** 宪章第八条之二规定了第九节的双层方案，但一个审议小组也没有召集过：名册对于抽签而言还太小，该条本身就这样写明；
- **未答复编年史不存在。** 它还没有建立；
- **独立的安全审计没有进行过。**
...
- [Earthlings 宣言](https://earth-lings.org/documents/zh/zh01-declaration.html)——第三、五、六、八、九、十和十一条
