...
**Il est vérifié que le participant est une personne vivante et qu'elle est unique.** L'unicité est vérifiée lors de la vérification d'identité, et c'est une condition de la signature de la Déclaration, non un souhait: un passeport délivré en contournant la vérification est annulé (Déclaration, article 8).
...
**Aucune mission ne crée de fonction.** Tout pouvoir est révoqué immédiatement et à un seuil qui n'est pas supérieur à celui auquel il a été confié; la délégation ne crée aucun avantage permanent.
...
Lors de la destruction, il ne reste dans la chaîne qu'une marque pseudonyme: le nom, le document, la biométrie et les hachages de vérification ne sont pas inscrits dans la chaîne. La liberté d'association n'exige pas l'effacement de l'histoire: la renonciation à une nationalité ne brûle pas les archives de l'État, et dans la pratique européenne relative aux registres paroissiaux le modèle d'annotation prédomine - l'inscription demeure, le statut est marqué (Italie, France, Irlande); la question de savoir si ce modèle suffit est actuellement tranchée par la Cour de justice de l'Union européenne (affaire C-12/25). « Cette personne a appartenu au peuple de la date X à la date Y » est un fait du passé, non une appartenance qui dure.
...
Pour les manquements graves aux règles communes, une seule mesure s'adresse à la personne - l'avertissement, et il ne retire rien: ni l'appartenance, ni la voix, ni le droit de faire des propositions, ni le droit de créer des cellules et d'y entrer, ni l'accès aux services, ni quoi que ce soit d'autre. Les autres mesures de la Charte s'adressent à un projet ou à une cellule: elles peuvent viser les ressources communes et ne peuvent pas viser les droits d'une personne.
...
Le droit de révision n'est pas pour autant retiré. Les principes de la Partie I de la Déclaration - les cinq principaux d'entre eux sont nommés à l'article 11 - ne sont abrogés par aucune majorité. Leur rédaction et tout le reste du texte de la Déclaration, le peuple les modifie lui-même - aux deux tiers des voix exprimées, avec quorum, et seulement de telle sorte qu'aucun principe ne soit restreint et qu'aucune garantie donnée à la personne ne devienne plus faible. Et si la réalisation de la Déclaration devient impossible, les earthlings vérifiés ont le droit de continuer le peuple sur une autre base, sur le même registre, qui est tenu dans la chaîne - aux conditions de l'article 11 de la Déclaration, dont la première est que le noyau soit intégralement conservé.
...
Précisons le stade sans détour: le texte constitutif n'est pas adopté, il n'y a pas un seul earthling, il n'y a pas de pratique d'autogouvernement. Le contrat du registre des passeports, la vérification d'identité, les cellules et la comptabilité de l'économie interne sont déployés et fonctionnent; le canal public de vote est déployé, mais aucun vote de fond n'y a encore eu lieu, l'outil de vote secret est en cours de sélection, et les contrats intelligents de la Trésorerie ne sont pas déployés (document « Où nous en sommes »); le remplissage de cette infrastructure par la pratique commence avec l'adoption du texte. Nous affirmons que la construction fonctionne, non que l'échelle est atteinte, et nous ne faisons pas passer l'un pour l'autre.
...
La question « que se passe-t-il si les décisions ne sont pas exécutées » est posée depuis le modèle étatique, où la décision est séparée de l'exécution et exige la contrainte. Ici, une part importante des décisions s'exécutera d'elle-même: le résultat d'un vote est mis en œuvre par le code, et la Charte confie à un contrat intelligent les versements par étapes aux projets approuvés (article 11). Aucun contrat intelligent de la Trésorerie n'est déployé, et il n'y a pas encore eu de votes de fond de l'Assemblée (document « Où nous en sommes »). Et là où les décisions sont de coordination, l'absence de contrainte n'est pas une défaillance, c'est la construction: contraindre est interdit par notre propre noyau.

Les différences avec une « base d'utilisateurs » sont observables et vérifiables, sans une seule auto-description. Un utilisateur accepte des conditions de service; un earthling signe une déclaration d'appartenance à un peuple, dont le texte a été ouvert aux propositions de toute personne et adopté par le vote de personnes vérifiées. Les utilisateurs n'ont aucun droit de gouvernance sur l'exploitant; ici, chacun a une voix égale et non achetable, détachée du paiement et du capital. Un service tire un profit de ses utilisateurs; ici, il y a un fonds commun et un circuit sans but lucratif. Un service exclut à son gré; ici, l'appartenance est inaliénable.

Et le point décisif: une base d'utilisateurs ne peut pas emporter la plateforme et partir; un peuple, une fois constitué, le pourra. Le registre des passeports vit dans la chaîne et non sur les serveurs de l'exploitant, et si, après l'adoption de la Déclaration, la réalisation de celle-ci devient impossible, les earthlings vérifiés pourront poursuivre l'existence du peuple sur une autre base technique ou organisationnelle, en s'appuyant sur le même registre (Déclaration, article 11).

La centralisation résiduelle de la période constituante et du stade de mise en place des structures, qui commence avec l'adoption de la Déclaration (Charte, article 39), nous l'avons exposée nous-mêmes, au même endroit, avec le plan de sa réduction: l'adversaire cite notre propre audit. Elle n'est pas un motif de disqualification: le CICR est à ce jour encore dirigé par un comité qui se coopte lui-même et composé exclusivement de ressortissants suisses, ce qui n'empêche ni sa personnalité juridique ni son statut d'observateur auprès de l'Assemblée générale des Nations Unies.
...
**Le texte constitutif n'est pas adopté.** Avant l'adoption du texte, il n'y a pas un seul earthling, il n'y a pas de pratique, et nul ne peut représenter le peuple.
