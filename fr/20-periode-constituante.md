...
Comment un peuple qui se crée lui-même adopte son propre texte constitutif

## Pourquoi une période constituante

Un peuple qui se crée lui-même doit adopter lui-même les règles sur lesquelles il sera fondé.

C'est pourquoi les Earthlings commencent par une période constituante.
...
Nous ne voulons pas créer d'abord un peuple avec des règles toutes faites, puis proposer à ses participants d'y consentir. Nous voulons que le processus même de constitution soit collectif.
...
La politique de confidentialité, les conditions d'utilisation, la politique de vérification biométrique, les mentions légales, ainsi que « La voix citoyenne », la base juridique, les objections et réponses, « Comment naît un sujet de droit », les questions fréquentes, « Qui sommes-nous », l'agenda de travail, « Où nous en sommes ».
...
| Les documents d'agencement | non | immédiatement | l'Assemblée, selon la procédure de la Charte |
| Documents extérieurs et de référence | non | immédiatement | l'Assemblée, sauf ce qui est prescrit par la loi |
...
## 04. Le test du noyau intangible

Un principe entré dans le noyau intangible ne peut plus jamais être abrogé. C'est pourquoi une proposition n'entre dans le noyau que si elle réunit les quatre conditions à la fois:

1. elle protège la personne contre le pouvoir du peuple lui-même, au lieu de décrire ce dont le peuple s'occupe;
2. elle se formule comme une interdiction, non comme une tâche;
3. elle est vérifiable: on peut établir si elle est violée ou non;
4. elle reste vraie même si nous nous sommes trompés dans notre appréciation des circonstances.

« La voix ne peut être achetée » remplit les quatre. « Le peuple s'occupe du climat » n'en remplit aucune: c'est une tâche, les tâches changent, et leur place est dans la Charte.

## 05. Comment participer

Il y a deux voies, et ce ne sont pas les mêmes.

**Envoyer une objection ou une proposition.** Sur n'importe quel document du corpus, et non seulement sur la Déclaration. Il n'est pas nécessaire d'adhérer, de faire vérifier son identité ni d'être d'accord avec nos conclusions. Il suffit de nommer le document et l'endroit visé; si vous ne savez pas comment s'appelle le document, décrivez-le avec vos mots, nous nous y retrouverons. Chaque proposition est publiée avec la réponse, qu'elle soit retenue ou rejetée, avec l'indication du motif du rejet.
...
La réponse est publiée en anglais et dans la langue de la proposition. Nous disons ici tout de suite ce que l'on nous demanderait autrement: pour le chinois, l'arabe, l'hindi et le géorgien, nous n'avons pas encore de locuteur natif, et la réponse dans ces langues peut être moins fluide qu'en anglais. Le sens de la réponse n'en change pas, et il n'y aura pas de différence de fond entre les versions.
...
Rien n'arrivera contre votre volonté.

Avant l'adoption, vous êtes participant à la constitution et non earthling: il n'y a encore rien à signer. Le jour de l'adoption, vous votez. Si le texte adopté ne vous convient pas, vous ne le signez tout simplement pas et vous partez - à tout moment, sans avoir à vous expliquer et sans l'accord de quiconque.

Aucune décision prise avant votre accord ne vous oblige à quoi que ce soit.
...
# Partie 2. Les règles de la période constituante

La présente partie établit la procédure à laquelle renvoie la section « Statut de la présente version » de la Déclaration.
...
Une proposition est reçue dans l'une quelconque des neuf langues du corpus: anglais, russe, allemand, espagnol, français, chinois, arabe, hindi et géorgien. La traduction de la proposition dans une autre langue n'est pas exigée de son auteur, et une proposition n'est pas rejetée en raison de sa langue.

La réponse est publiée en anglais et dans la langue de la proposition.

**Deux types de propositions, aux conséquences différentes.**

Une proposition **de fond** modifie le sens du texte. Elle est intégrée au texte-maître russe, reproduite dans l'anglais, et les mêmes modifications sont ensuite reportées dans les sept autres langues. La langue dans laquelle la proposition est parvenue n'y change rien.

Une proposition **de traduction** signale qu'une traduction rend le sens de manière inexacte. Elle corrige le texte de la seule langue à laquelle elle se rapporte et ne modifie pas le sens du document. Elle ne constitue pas une proposition de modification de la Déclaration et n'est pas soumise au vote.
...
Chaque proposition reçue est publiée avec la réponse qui lui est faite, qu'elle soit retenue ou rejetée, avec l'indication du motif du rejet. La réponse est publiée dans un délai maximal de trente jours à compter de la réception de la proposition et, pour les propositions parvenues dans les trente derniers jours de la réception, au plus tard le jour de la publication du relevé.
...
## 5. La vérification d'identité pendant la période

À la vérification d'identité pendant la période constituante s'appliquent temporairement les règles de l'article 8 de la Déclaration dans sa présente version.
