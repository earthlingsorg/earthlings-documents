...
> **Ce qu'il advient de votre biométrie.** Les images d'origine et les scans de documents **ne sont pas conservés** après la vérification. Ce qui subsiste exactement et pourquoi figure dans la [Politique de vérification biométrique](https://earth-lings.org/documents/fr/fr16-verification-biometrique.html).
...
**Votre voix vaut celle de tout autre.** Elle ne dépend ni de l'argent, ni de la réputation, ni de l'ancienneté, ni du nombre d'unités de compte sur votre compte.

**Vous pouvez partir à tout moment** - de vous-même, sans avoir à vous expliquer, et nul ne peut y faire obstacle, pas même le fondateur.

**Vous participez directement** - vous faites des propositions et vous votez sur chaque question, et non une fois tous les quelques années.

---

## 4. Ce que le passeport ne donne pas

Il importe de le savoir avant de payer et non après.

- **il ne donne aucun droit de visa** et n'a aucun effet sur le franchissement des frontières;
- **il ne remplace pas les documents de votre État** et n'est pas une pièce d'identité;
- **il n'a aucune force devant les administrations** d'aucun pays;
...
## 5. Ce que l'on attend de vous

- respecter les principes de la Déclaration;
- traiter les autres participants avec respect;
...
## 6. Le changement de statut

**Actif.** Accès complet à toutes les possibilités.
...
## 7. Quand ce n'est pas vous qui détruisez le passeport
...
Il n'existe pas d'autres motifs, et contre votre volonté le passeport ne peut être détruit que dans le premier cas. Le décès du titulaire n'en fait pas partie: l'appartenance prend fin d'elle-même, sans décision de quiconque, et le passeport demeure au registre. Le peuple n'a pas accès aux registres de décès du monde entier, et un tel motif reposerait sur des informations que rien ne permet de vérifier.

---

## 8. Sur la cotisation

Elle est unique: après réception du passeport, il n'y a aucun paiement annuel ni mensuel. Elle entre au trésor commun et est répartie selon les parts publiées dans le document [Trésorerie](https://earth-lings.org/documents/fr/fr09-tresorerie.html).

Les unités de compte que vous avez reçues pour votre apport demeurent votre propriété et ne sont, à la sortie, ni confisquées ni annulées.

Pour en savoir plus sur ce qu'il advient du passeport et des données: [Passeport SBT de l'earthling](https://earth-lings.org/documents/fr/fr15-passeport-sbt.html).
...
On ne peut pas choisir une personne déterminée: c'est la tête de file qui est payée. C'est délibéré. Dès qu'il devient possible de choisir qui exactement, un protecteur apparaît, et derrière lui une dépendance; dans un peuple où tous sont égaux, cela n'a pas sa place. Le payeur ne sait pas pour qui il a payé. Celui pour qui l'on a payé ne sait pas qui a payé.

Sont publiquement visibles le nombre de personnes dans la file et le nombre de cotisations déjà payées. Le nom du payeur est publié s'il le souhaite: l'anonymat est possible.

**Pourquoi ainsi et non par une exonération.** Une exonération exige que la personne déclare sa pauvreté et que nous la vérifiions. Rien ne permet de le vérifier à l'échelle du monde, et nous ne voulons pas obliger quelqu'un à prouver son besoin pour entrer dans un peuple qui parle de dignité. Ici, personne ne déclare rien sur soi: la personne ne dit pas « je suis pauvre », mais « j'ai besoin d'une cotisation », et ce qui décide ensuite n'est pas ce qu'elle a dit, mais la disposition d'un autre à payer.

La cotisation est pour autant toujours versée intégralement. Le trésor reçoit la même somme pour chaque passeport, et personne n'obtient une entrée moins chère qu'un autre.
