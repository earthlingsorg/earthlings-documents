# Conditions d'utilisation du peuple des Earthlings

**Entrent en vigueur dès leur publication**

> En cas de divergence entre les présentes Conditions et la [Charte](https://earth-lings.org/documents/fr/fr05-charte.html), la Charte s'applique, et en cas de divergence entre la Charte et la [Déclaration](https://earth-lings.org/documents/fr/fr01-declaration.html), la Déclaration. Le traitement des données est décrit dans la [Politique de confidentialité](https://earth-lings.org/documents/fr/fr28-politique-de-confidentialite.html).
...
- les lois de votre pays ne sont pas affectées, aucune renonciation à votre nationalité n'est exigée;
- le passeport atteste une appartenance et ne remplace aucun document.

---

# SECTION 01. Sur la nature de ces conditions

La plupart des conditions d'utilisation sont écrites par des sociétés pour protéger des sociétés. Ce document n'en est pas.

Les présentes conditions décrivent comment les participants du peuple interagissent entre eux: quels droits ils ont et quels engagements ils prennent volontairement.

**Un langage simple.** Nous évitons le jargon juridique partout où c'est possible. Si une clause est incompréhensible, c'est qu'elle est mal écrite.

**La réciprocité.** Ce n'est pas une liste de restrictions pour vous et de privilèges pour nous.
...
# SECTION 02. Sur le peuple des Earthlings
...
# SECTION 03. Appartenance et inscription
...
**Ce qui est attendu:** le respect des principes de la Déclaration. La mesure de la participation reste à votre appréciation: aucune activité n'est obligatoire.
...
# SECTION 04. Les règles de la vie commune

## Ce qui est bienvenu

- le respect des autres, quelles que soient leur origine, leurs opinions et leur identité;
- la critique constructive et l'échange d'idées;
- l'apport à l'œuvre commune: projets, initiatives, aide aux autres;
- l'ouverture au dialogue;
- la protection de ceux qui sont vulnérables.
...
> **Sur la liberté d'expression.** Nous protégeons le droit d'exprimer des opinions, y compris impopulaires, et le désaccord avec les décisions du peuple n'entraîne jamais de conséquences. Mais un propos visant à causer un préjudice à une personne déterminée n'est plus une opinion.
...
# SECTION 05. Les contenus et les droits sur ceux-ci

## Vos contenus

Tout ce que vous créez et publiez demeure vôtre. En publiant un contenu, vous en autorisez l'affichage et la diffusion auprès des participants dans le cadre du fonctionnement de la plateforme, avec mention de son auteur, y compris la traduction et les transformations techniquement nécessaires. Cela ne crée aucun autre droit, et l'autorisation prend fin avec la suppression du contenu.

Nous recommandons les licences ouvertes, mais le choix vous appartient toujours.

## Les contenus de l'infrastructure

Les documents, les outils et les matériaux créés par l'infrastructure elle-même sont publiés sous licences ouvertes.

## Les droits d'autrui

Vous vous engagez à ne pas publier de contenus portant atteinte aux droits d'auteur d'autrui, à indiquer vos sources en citant, à respecter les conditions des licences et à respecter les données personnelles des autres.

En cas de réclamation fondée, le contenu litigieux est retiré, et son auteur en est informé et a le droit d'objecter.

---

# SECTION 06. Le passeport
...
> Les marques de participation accumulées dans le système ont un caractère exclusivement informatif: elles n'influent ni sur le poids de la voix ni sur l'accès à un rôle quelconque (Charte, article 8).
...
# SECTION 07. L'unité de compte

## Sa nature

L'Earthlings Coin est une unité utilitaire de l'économie interne. Ce n'est ni une action, ni un instrument d'investissement, ni une promesse de bénéfice.

**À quoi elle sert:** payer des services au sein de l'écosystème, soutenir des projets, rémunérer un apport.
...
Le détail figure dans le document [Earthlings Coin](https://earth-lings.org/documents/fr/fr10-earthlings-coin.html).

## Votre responsabilité

Le respect de la législation de votre pays sur les actifs numériques; l'imposition des opérations; la conservation sûre de vos clés; la compréhension des risques. Les présentes Conditions ne constituent ni un conseil fiscal ni un conseil en investissement.

---

# SECTION 08. La prise de décision
...
3. **Vote.** Selon les seuils et les quorums établis par la Charte.
4. **Exécution.** Automatiquement par contrats intelligents, ou par les structures techniques en exécution de la décision.
5. **Transparence.** L'historique des propositions, des débats et des résultats est public.

## Ce qui se décide par un vote

Tout ce qui est important: modification de la Charte et des règles; répartition des fonds communs et financement des projets; élection et révocation des Core Nodes, de l'Emergency Multisig et du Conseil indépendant; restriction de pouvoirs et suspension du droit de vote; orientations stratégiques; partenariats; paramètres de la plateforme.
...
# SECTION 09. Les cellules

Les cellules sont de petites équipes de participants travaillant sur des projets déterminés: techniques, éducatifs, de recherche, culturels, sociaux.
...
La sortie d'une cellule est toujours libre et n'affecte ni l'appartenance au peuple ni le droit de vote. Le détail figure dans le document [Cellules des Earthlings](https://earth-lings.org/documents/fr/fr08-cellules.html).

---

# SECTION 10. La responsabilité et ses limites
...
- informer de façon transparente des problèmes et des changements;
- examiner les demandes dans des délais raisonnables;
- examiner de bonne foi les demandes relatives à un préjudice documenté lié à nos erreurs techniques, et rechercher une solution équitable.

## Ce dont vous répondez

Le respect de la législation de votre pays; la sécurité de vos propres clés et identifiants; les conséquences de vos actes; la compréhension des risques des actifs numériques.

## Ce dont nous ne répondons pas

- les actes des participants les uns envers les autres;
- la perte de vos clés cryptographiques: elles ne se restaurent pas;
...
# SECTION 11. Cotisation, remboursement et défaillances techniques

## La nature de la cotisation

La cotisation est versée une fois, couvre le prix de revient de la procédure - vérification d'identité et délivrance du passeport - et soutient l'infrastructure du peuple; elle entre au trésor commun et est répartie selon les parts publiées. Elle **n'achète pas l'appartenance** - celle-ci naît de la signature de la Déclaration - et ne donne ni voix ni unités de compte.
...
Les dons excédant la cotisation sont entièrement volontaires, n'influent pas sur le statut et ne sont pas remboursables.
...
# SECTION 12. Droit applicable et différends
...
# SECTION 13. Les modifications des Conditions
...
- vous avez pris connaissance des présentes Conditions dans leur intégralité;
- vous en comprenez le contenu et les conséquences;
- vous consentez volontairement, sans contrainte;
- vous avez atteint l'âge de 18 ans;
- vous avez le droit de prendre de tels engagements dans votre ordre juridique.

La version en vigueur des présentes Conditions, la Déclaration, la Politique de confidentialité et tous les documents liés sont accessibles en permanence sur earth-lings.org et ouverts avant l'adhésion.

---

**Pour toute question relative aux présentes Conditions:** info@earth-lings.org
**Pour toute question relative au traitement des données:** privacy@earth-lings.org
